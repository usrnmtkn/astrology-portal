...
export default defineConfig({
  ...
  testMatch: ["calendar-season-phrases.spec.ts", "calendar-template-preview.spec.ts", "sky-forecast-studio.spec.ts", "content-dashboard-admin-user-flows.spec.ts", "calendar-summary-studio.spec.ts", "sky-summary-studio.spec.ts", "sky-placement-variables.spec.ts", "house-transit-combined-editor.spec.ts"],
