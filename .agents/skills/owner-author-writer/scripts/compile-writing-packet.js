...
const retrievalExclusions = require(path.join(packageRoot, "voice", "tldr-astro", "owner-author-writer", "retrieval-exclusions.json"));
const formatExemplarDataset = require(path.join(packageRoot, "voice", "tldr-astro", "owner-author-writer", "sky-placement-format-exemplars-v4.json"));
const ownerCorpusWarmthFoundations = require(path.join(packageRoot, "voice", "tldr-astro", "owner-author-writer", "owner-corpus-warmth-foundations-v1.json"));
