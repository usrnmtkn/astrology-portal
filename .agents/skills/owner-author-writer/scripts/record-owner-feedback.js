...
const datasetPath = path.join(packageRoot, "voice", "tldr-astro", "owner-author-writer", "contrastive-edits.json");
...
function main() {
  ...
  const preview = {
    ...
    nextCommands: [
      ...
      "git diff -- packages/astro-knowledge/voice/tldr-astro/owner-author-writer"
    ]
  };
  if (options.apply) {
