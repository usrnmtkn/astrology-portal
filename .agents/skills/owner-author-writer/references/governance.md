...
The machine policy is `packages/astro-knowledge/voice/tldr-astro/owner-author-writer/authority-policy.json`.
...
- Third-party text never becomes Project Author phrasing.
