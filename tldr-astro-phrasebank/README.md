...
phrasebank/reviewed-clauses.json        Reader-ready AUTHORED clauses in Project Author voice, keyed by surface +
...
- Missing exact source -> `SOURCE_GAP`. Never compose prose from keywords, prompts, feedback, reports, or raw  copy.
