...
This bundle is the reviewed content system for a CHANI-style astrology app written in Project Author's voice. It is a Python **phrasebank + composers + validation-harness** repo. Everything
