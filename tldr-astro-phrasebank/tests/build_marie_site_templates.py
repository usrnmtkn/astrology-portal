#!/usr/bin/env python3
"""
build_marie_site_templates.py — the curated Marie voice layer from private-author-source.invalid.
...
for i, (exact, tmpl, article, slug, fam) in enumerate(LINES, 1):
    records.append({
        ...
        "exact": {"text": exact, "tier": "CONFIRMED",
                  "source": f"Project Author — {article}",
                  "url": f"https://private-author-source.invalid/blogs/astrology/{slug}"},
