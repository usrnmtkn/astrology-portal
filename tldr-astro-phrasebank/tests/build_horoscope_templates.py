...
private-author-source.invalid). Register is second-person ('you') — correct for personalized surfaces,
   ...
   "note":"built from the site templates; swap in the reader's real transit at render"}},
{
 ...
 "composition":"Open with the week's arc ('This week carries you from X into Y'). Then "
               ...
               "Add 1-3 calculated transit markers for the key exact aspects. Close with one "
               "collective, actionable line.",
 "source":["This Week's Astrology: August 30 – September 7 (structure)"],
 "example":{"tier":"REVIEWED_EXAMPLE","source":"Project Author — This Week's Astrology: August 30 – September 7",
   "url":"https://private-author-source.invalid/blogs/astrology/this-weeks-astrology-august-30-september-7-2025",
   "text":"This week teaches that perfection was never the goal: integration was. You've "
          "been using your systems to outrun a feeling. Mars quincunx the True Node tests "
          "what you started and asks for an adjustment. Your body "
          "has been keeping score while you've been keeping peace."}},
{
 ...
 "example":{"tier":"CONFIRMED","source":"Project Author — This Week's Astrology: August 30 – September 7",
   "url":"https://private-author-source.invalid/blogs/astrology/this-weeks-astrology-august-30-september-7-2025",
          ...
          "started running you instead."}},
{
 ...
 "example":{"tier":"CONFIRMED","source":"Project Author — Taurus Full Moon (Aries Rising)",
   "url":"https://private-author-source.invalid/blogs/astrology/full-moon-in-taurus",
          ...
          "resources available that you haven't considered yet."}},
{
 ...
 "example":{"tier":"CONFIRMED","source":"Project Author — Libra New Moon (Taurus)",
   "url":"https://private-author-source.invalid/blogs/astrology/libra-new-moon-2025",
