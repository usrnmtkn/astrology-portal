    ...
    for k in ms:
        if k.startswith("ms/" + prefix + "/"):
            ...
            records.append({
                ...
                "source": "@project-author / private-author-source.invalid (marie-source-phrases.json)",
                "serving": "may serve verbatim; never seam- or register-linted (author's own voice)",
            })

out = {"_meta": {"title": "Project Author CONFIRMED lines (pull-quotes, essay-quotes, aphorisms)",
