...
URL_NM = "https://private-author-source.invalid/blogs/astrology/libra-new-moon-2025"
URL_FM = "https://private-author-source.invalid/blogs/astrology/full-moon-in-taurus"
...
for sign, (house, text) in NEW_MOON_LIBRA.items():
    records.append({
        ...
        "source": f"Project Author — Libra New Moon ({sign.title()})", "url": URL_NM,
...
for sign, (house, axis, text) in FULL_MOON_TAURUS.items():
    records.append({
        ...
        "text": text, "tier": "CONFIRMED",
        "source": f"Project Author — Taurus Full Moon ({sign.title()} Rising)", "url": URL_FM,
        "serving": "serve-verbatim; never tone-passed or linted",
    })
