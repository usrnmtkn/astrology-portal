...
export function calendarWritingStudioHref(contentKey: string) {
  ...
  if (
    ...
    params.set("view", key.startsWith("authored/calendar-moon-transition/") ? "lunar-ingresses" : key.startsWith("authored/calendar-season-transition/") ? "season-transitions" : "daily-sky");
