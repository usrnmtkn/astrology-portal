...
import { correctedReaderSource } from "../content/fallbackArchitectureV3/resolver/readerSourceReferenceCorrections.mjs";
...
function fromRow(
  ...
  return {
    ...
    summary: correctedReaderSource(row.content_key, "summary", row.summary),
    body: row.body,
