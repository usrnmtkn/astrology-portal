...
export function Stack({ as: Tag = "div", gap = "lg", className, children, ...props }: StackProps) {
  return <Tag className={cx("live-ds-stack", className)} data-gap={gap} {...props}>{children}</Tag>;
}
...
export function Inline({ as: Tag = "div", gap = "sm", align = "start", justify, className, children, ...props }: InlineProps) {
  return (
    <Tag
      className={cx("live-ds-inline", className)}
      data-gap={gap}
      data-align={align}
...
export function Box({ as: Tag = "div", padding, radius, className, children, ...props }: BoxProps) {
  return (
    <Tag className={cx("live-ds-box", className)} data-padding={padding} data-radius={radius} {...props}>
      {children}
    </Tag>
  );
}
...
export function Grid({ as: Tag = "div", className, children, ...props }: GridProps) {
  return <Tag className={cx("live-ds-grid", className)} {...props}>{children}</Tag>;
}

type ContainerProps = HTMLAttributes<HTMLDivElement> & { children: ReactNode };

export function Container({ className, children, ...props }: ContainerProps) {
  return <div className={cx("live-ds-container", className)} {...props}>{children}</div>;
}
...
export function Text({ as: Tag = "p", size = "body", tone = "primary", className, children, ...props }: TextProps) {
  return (
    <Tag className={cx("live-ds-text", className)} data-size={size} data-tone={tone} {...props}>{children}</Tag>
  );
}
