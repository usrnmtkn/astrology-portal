...
export const CALENDAR_ASPECT_CONTENT_STUDIO_PACKAGE_VERSION = CALENDAR_ASPECT_DRAFT_PACKAGE_VERSION;
...
export function calendarAspectStudioRecord(source, draft) {
  ...
  return {
    ...
    source_package: CALENDAR_ASPECT_CONTENT_STUDIO_PACKAGE_VERSION,
