...
```
CC / Project Author phrase banks, book extractions      → fallback_source (never render)
...
The instruction-source firewall from SOURCE-TIER-CONTRACT.md applies unchanged: prompts, chat feedback, audits, fixtures, screenshots, and raw  copy can never become slot values or hooks.
