...
function fillTransitFriendNameSlot(body, voice = "you") {
...
function createTransitSynastryRenderer(transitLib, templatesFile, rowsFile, opts2 = {}) {
  ...
  function fillTransitFriendNameSlotLocal(body, voice = "you") {
    if (!body || voice === "you") return body;
...
${passHook2}`;
    ...
    const cScenesRaw = hookVoice(`fallback-hook/transit-house-event-scenes/${transiting}/${natal}/${effectFamily}`, v) ?? hookVoice(`fallback-hook/transit-effect-${effectFamily}/${transiting}/${natal}`, v);
