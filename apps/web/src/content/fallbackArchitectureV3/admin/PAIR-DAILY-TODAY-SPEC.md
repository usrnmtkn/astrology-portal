...
Status: SPEC ONLY. Nothing renders until the owner approves the frame copy described
in "New copy required." Drafted 2026-08-06 after comparing the Co-Star friend
Compatibility surface; product direction confirmed by the owner in session.
...
Reference model (Co-Star, observed 2026-08-06): "@project-author, your goal is to explore
...
you-voice ("@project-author, you are …"). The reader is never referred to in third
