...
export function resolveStudioVariableCopy(copy: unknown, bindings?: StudioVariableDefinition[], context?: Record<string, any>, deferredNames?: readonly string[]): string;
export function resolveStudioVariableRecord<T extends Record<string, any>>(record: T, context?: Record<string, any>, deferredNames?: readonly string[]): T;
