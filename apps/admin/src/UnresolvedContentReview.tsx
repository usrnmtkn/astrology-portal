...
{visibleIssues.map((issue) => {
              ...
              return <tr key={issue.contentKey}>
                ...
                <td data-label="What it means">
                  ...
                  {issue.resolution && <details className="studio-contained-disclosure admin-unresolved-diagnosis"><AdminDisclosureSummary>Codex diagnosis</AdminDisclosureSummary><p>{issue.resolution.diagnosis}</p></details>}
                </td>
                <td data-label="Source records"><details className="studio-contained-disclosure"><AdminDisclosureSummary>{issue.records.length} record(s)</AdminDisclosureSummary>{issue.records.map((record) => <code key={record.id}>{record.reviewStatus}: {record.sourcePath}{record.objectPath}</code>)}</details></td>
