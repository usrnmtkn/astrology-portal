...
const sourcePrefixExceptions: Record<string, string[]> = {
  ...
  compatDomain: ["fallback-vocab/compatibility-", "fallback-vocab/relationship-"],
  elementPattern: ["fallback-vocab/element-pattern/", "fallback-hook/element-pattern/"],
  transitTypeLine: ["fallback-hook/transit-type/"],
  transitEffectLine: ["fallback-hook/transit-effect/"],
  houseEffect: ["fallback-vocab/transit-house/", "fallback-hook/transit-effect-house/"],
  retroMeaning: ["fallback-hook/retrograde/", "fallback-hook/retro-"],
