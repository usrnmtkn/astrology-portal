...
export function buildQuestionBoundAskTldrJudgeRequest(input: {
  ...
  const instructions = [
    ...
    pillarId === "career" && isDirectional
      ? "CAREER DIRECTION STANDARD: Prefer specific distinctions involving scope, authority, ownership, leverage, resources, responsibility, visibility, recognition, and control of the outcome. Do not reward generic language about worth, scrutiny, confidence, or ambition when the supplied astrology supports a more concrete professional distinction. Do not require a responsibility-versus-authority conclusion when this question and its supplied meaning support a different distinction."
      : "",
