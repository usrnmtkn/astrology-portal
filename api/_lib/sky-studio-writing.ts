import generator from "../../packages/astro-knowledge/scripts/generate-sky-aspect-cards.js";
...
export async function runStudioSkyWriting(key: string, action: "generate" | "recheck", body: string, source?: any) {
