...
The machine-readable policy remains in the repository voice policy JSON and generated
`src/astro-writing/policyData.generated.mjs`. The following owner wording is verbatim.
