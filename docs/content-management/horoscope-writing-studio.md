...
2. Open **Preview** to see the assembled editorial instructions. The governed run supplies facts, source evidence, argument approval and the response schema separately.
