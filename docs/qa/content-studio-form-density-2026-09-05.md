...
- Narrow editor footers squeezed Save, publish, and archive actions into three cramped columns and forced unnecessary label wrapping.
...
- On narrow editors, gave the publish action a full-width row and kept the secondary Save/archive actions in a readable two-column row.
