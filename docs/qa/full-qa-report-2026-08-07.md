...
- The prompt contains active `ED-013`/`CF-016` policy language about CC/SD constructions and -adjacent voice, but the test requires the literal phrase `CC/SD/AC` or `, Spirit Daughter, or AC`.
