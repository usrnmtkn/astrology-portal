...
- Signed-in/local profile: "Project Author" seeded in localStorage with complete birth details, current location, and two friend charts.
- Default test location: New York, NY.
