...
Increase the entry gzip allowance from 175,500 to 176,000 bytes and the aggregate allowance from 309,000 to 309,500 bytes. Each increase is 500 bytes (under 0.3% of its previous allowance). The entry and largest-chunk raw limits remain 618,500 bytes. Deferred content markers, the three lazy editor groups, and the composition/fallback dynamic-entry requirements remain enforced.
