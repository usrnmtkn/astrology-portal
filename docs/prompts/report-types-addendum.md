...
- Reference implementation: `private:report/general-2026` (owner-authored final).
...
- Reference implementation: `private:report/work-money-2026` (owner-authored).
...
- Reference implementation: `private:report/love-connection-2026` (owner-authored).
