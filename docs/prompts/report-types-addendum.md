...
- Reference implementation: `artifacts/owner-author-year-ahead-2026-FINAL.md` (owner-authored final).
...
- Reference implementation: `artifacts/owner-author-work-money-2026-owner-v1.md` (owner-authored).
...
- Reference implementation: `artifacts/owner-author-love-connection-2026-owner-v1.md` (owner-authored).
