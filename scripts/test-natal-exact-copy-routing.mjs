...
assert.equal(natalAspectRows.length, 241, "The protected exact natal-aspect calibration set must contain 241 rows.");
...
const aspectProjection = natalAspectRows.map(({
...
assert.ok(exactAspect && exactHouse);
