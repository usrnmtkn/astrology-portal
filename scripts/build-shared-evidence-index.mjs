...
const voiceIndex = readJson("packages/astro-knowledge/voice/tldr-astro/owner-author-writer/voice-index.json");
const surfacePool = readJson("packages/astro-knowledge/voice/tldr-astro/owner-author-writer/surface-qualified-positive-exemplars-v2.json");
