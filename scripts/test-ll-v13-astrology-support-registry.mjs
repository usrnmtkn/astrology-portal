...
const artifactPath = path.join(repoRoot, "packages/astro-knowledge/voice/tldr-astro/owner-author-writer/ll-matrix-v13/ll-matrix-v13-astrology-support-v1.json");
const matrixPath = path.join(repoRoot, "packages/astro-knowledge/voice/tldr-astro/owner-author-writer/ll-matrix-v13/ll-matrix-v13.json");
