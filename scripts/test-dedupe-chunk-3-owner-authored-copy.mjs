...
const payloadPath = "packages/astro-knowledge/review/chunk3-owner-authored-payloads.json";
const reviewRoot = "packages/astro-knowledge/review/dedupe-chunk-3-owner-authored-v1";
...
assert.equal(renderCount, 120);

console.log("Dedupe chunk 3: 30 owner-authored exact approvals, 30 source/bundle contracts, 30 fail-closed governed entries, 10 aspect-distinct pairs, and 120 Node/browser renders PASS.");
