...
const surfaceQualifiedPool = JSON.parse(fs.readFileSync(
  path.join(repoRoot, "packages/astro-knowledge/voice/tldr-astro/owner-author-writer/surface-qualified-positive-exemplars-v2.json"),
  "utf8"
));
const voiceIndex = JSON.parse(fs.readFileSync(
  path.join(repoRoot, "packages/astro-knowledge/voice/tldr-astro/owner-author-writer/voice-index.json"),
  "utf8"
));
