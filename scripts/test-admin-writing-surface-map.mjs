...
assert.equal(writingSurfaceAdminAccess["personal-transit-detail"].cmsStarters, undefined);
assert.equal(writingSurfaceAdminAccess["personal-transit-detail"].routes[0].hash, "#sky-writeups?view=transits-to-natal");
