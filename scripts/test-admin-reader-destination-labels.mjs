...
const css = fs.readFileSync(path.join(root, "apps/admin/src/studio-system.css"), "utf8");
...
assert.match(css, /\.admin-reader-destination-line/u);
assert.match(css, /\.admin-editor-reader-destination/u);
