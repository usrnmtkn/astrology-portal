...
assert.match(coverageEndpoint, /resolveAspectPatternCopy\(context, \{ authoredRecords: AUTHORED_ASPECT_PATTERN_RECORDS \}\)/);
assert.match(coverageEndpoint, /resolveAspectPatternCopy\(context, \{ authoredRecords: \[\] \}\)/);
