...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as directory:
        ...
        importer.APPROVED_OVERLAY.write_bytes((REPO_ROOT / "packages/astro-knowledge/voice/tldr-astro/owner-author-writer/ll-matrix-v13/wp1-owner-approved-locked.json").read_bytes())
        original_locked = (REPO_ROOT / "packages/astro-knowledge/voice/tldr-astro/owner-author-writer/ll-matrix-v13/knowledge-matrix-v13-owner-approved-locked.json").read_bytes()
