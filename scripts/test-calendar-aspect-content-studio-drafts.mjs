...
assert.match(contentStudioDashboard, /calendarAspectWorkspaceActive\s*\? "Calendar Aspect Cards"/u);
assert.match(contentStudioDashboard.replace(/<\/?strong>/gu, ""), /Live means readers can currently receive this copy\. Not live means readers cannot currently receive this copy\./u);
