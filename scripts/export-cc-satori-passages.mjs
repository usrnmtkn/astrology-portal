...
const satoriBookPath = "packages/astro-knowledge/sources/authored/owner-author-book/celestial-alchemy-natal-placement-excerpts.json";
...
writeText(
  ...
  [
    ...
    "- `satori-confirmed-article-quotes.*`: confirmed Project Author article quotes marked serve-verbatim.",
    "- `satori-book-natal-placement-excerpts.*`: natal placement excerpts from the Project Author book source; includes the used astrology body plus preserved source body for review.",
