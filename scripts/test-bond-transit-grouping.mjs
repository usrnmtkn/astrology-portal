...
assert.equal(joseCard.headline, "Transiting Saturn sextile Jose's Mars");
assert.equal(joseCard.parts.length, 2);
assert.equal(
  joseCard.parts[1],
  "Saturn in Aries is sextile Jose's Mars until November 13, activating the connections his Mars makes with your Moon, your Midheaven, and your Lilith."
);
...
assert.equal(chrisCard.headline, "Transiting Saturn square your Venus");
assert.equal(
  chrisCard.parts[1],
  "Saturn in Aries is square your Venus until November 13, activating the connections it makes with Chris's Mercury, Saturn, and Midheaven."
);
...
assert.equal(
  single.parts[1],
  "Saturn in Aries is sextile Jose's Mars until November 13, activating the connection it makes with your Moon."
);
