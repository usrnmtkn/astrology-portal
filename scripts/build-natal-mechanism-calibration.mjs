...
if (fixture.positive?.length !== 3 || fixture.negative?.length !== 8) {
  throw new Error("Natal mechanism calibration must contain exactly three positive and eight negative fixtures.");
}
