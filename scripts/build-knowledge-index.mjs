...
// ------------------------------------------------------------- store 2: V13
{
  const p = path.join(repoRoot, "packages/astro-knowledge/voice/tldr-astro/owner-author-writer/ll-matrix-v13/ll-matrix-v13.json");
  const j = readJson(p);
...
{
  const p = path.join(repoRoot, "packages/astro-knowledge/voice/tldr-astro/owner-author-writer/ll-matrix-v13/knowledge-matrix-v13-owner-approved-locked.json");
  const j = readJson(p);
...
for (const [store, p] of [
  ["book-ms-ca", "packages/astro-knowledge/sources/authored/owner-author-book/celestial-alchemy-license-quote-extract.json"],
