...
console.log("Ask TLDR writer contract passed: no provider call is enabled, the request separates calculated facts, governed meaning, and owner register evidence, and output must cite the ranked primary evidence without leaking internal metadata or banned prose.");
