...
assert.equal(report.sourceReachability.eligibleExactRows, 404);
...
console.log("Canonical source reachability passed: 404 eligible exact rows classified; legacy exact-row cohort fully reconciled; 2,765 authored keys inventoried without migration.");
