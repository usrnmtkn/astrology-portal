...
const benchmark = fs.readFileSync(new URL("../artifacts/owner-author-year-ahead-2026-FINAL.md", import.meta.url), "utf8");
...
const document = buildGeneralYearReviewedReportDocument({
  ...
  facts, readerProfile: { handle: "project-author", displayName: "Project Author" }, units
});
assert.throws(() => buildGeneralYearReviewedReportDocument({
  ...
  periodStart: "2026-02-18", periodEnd: "2027-02-17", factsEngine: "fixture", factsHash: "fixture-hash",
  facts, readerProfile: { handle: "", displayName: "Project Author" }, units
...
assert.equal(document.cover.handleLine, "@project-author, protect your time for the work that needs quiet.");
...
assert.ok(document.colophon.entries.includes("FOR Project Author, BORN January 1, 1990, 11:20 AM"));
...
const generation3 = fs.readFileSync(new URL("../artifacts/owner-author-generation-3-client-delivery.md", import.meta.url), "utf8");
...
const rerender = fs.readFileSync(new URL("../artifacts/owner-author-generation-3-package-2-structural-rerender.md", import.meta.url), "utf8");
