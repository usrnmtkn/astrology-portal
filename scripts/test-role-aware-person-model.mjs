...
assert.throws(
  () => renderRoleTaggedFragment({
    id: "fixture/ambiguous-pronoun",
    scope: "shared_fragment",
    roles: [],
    template: "You need time alone."
...
console.log("Role-aware person model passed: role identity, name-first policy, pronoun preference, singular/plural verb agreement, viewer preservation, other-person handling, and ambiguity fail-closed behavior.");
