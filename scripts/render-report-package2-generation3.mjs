...
const sourcePath = new URL("../artifacts/owner-author-generation-3-client-delivery.md", import.meta.url);
const outputPath = new URL("../artifacts/owner-author-generation-3-package-2-structural-rerender.md", import.meta.url);
...
const colophon = buildCustomerReportColophon({ facts, periodStart: "2026-02-18", periodEnd: "2027-02-17", displayName: "Project Author" });
const lines = [
  ...
  "# @project-author, protect your time for the work that needs quiet.", "", reportGlyphLine(facts), "", "---", ""
];
