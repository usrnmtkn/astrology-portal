...
assert.match(app, /if \(showNatalAspectPatterns\) {\s*fetchNatalAspectPatternsWithCopy\(birthLocation, birthDateTime\)/s, "Natal aspect-pattern copy must load only when the feature is enabled.");
