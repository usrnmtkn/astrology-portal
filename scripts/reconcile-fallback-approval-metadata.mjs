...
const record = {
  ...
  ungatedByReason,
  gateDecision: {
    currentAcceptedLevels: ["exact_owner_approved", "owner_signoff_untraced"],
    changedByThisMigration: false,
    authority: "Owner ruling, 2026-08-13: accept both levels.",
    implementationScope: "PR #229 changes the Friends gate; this migration changes fallback approval metadata only.",
    recommendation: "Keep both levels distinct in metadata and provenance displays."
  }
};
