...
export default defineConfig({
 testDir: "./tests/visual", testMatch: ["house-transit-loading.spec.ts", "sky-ingress-composer.spec.ts", "sky-placement-composition.spec.ts", "sky-placement-variables.spec.ts", "content-studio-recovery.spec.ts"], timeout: 90_000,
