...
The first six-card GPT-5.6 pilot and its prompt-leakage findings are documented in `sky-placement-rewrite-pilot-gpt-5.6-2026-08-02.md`. The tuned second pilot and its four owner-review candidates are documented in `sky-placement-rewrite-pilot-v2-gpt-5.6-2026-08-02.md`.
