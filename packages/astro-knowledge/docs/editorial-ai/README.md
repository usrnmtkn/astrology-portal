...
| Governed Satori writer environment | `.agents/skills/satori-writer/`, `voice/tldr-astro/satori-writer/`, `docs/editorial-ai/MARIE-SATORI-WRITER-IMPLEMENTATION-2026-08-02.md` |
