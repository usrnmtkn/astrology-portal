...
| Governed Project Author writer environment | `.agents/skills/owner-author-writer/`, `voice/tldr-astro/owner-author-writer/`, `docs/editorial-ai/owner-author-WRITER-IMPLEMENTATION-2026-08-02.md` |
