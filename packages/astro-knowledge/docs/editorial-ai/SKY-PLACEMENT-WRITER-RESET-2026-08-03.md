...
The superseded compiler is preserved at `.agents/skills/owner-author-writer/scripts/compile-writing-packet-legacy-audit.js`. Its compiled packet exposed positive examples, contrastive edits, negative examples, the current AI candidate, failure tags, selection explanations, candidate-language ranking, and governance metadata before drafting.
