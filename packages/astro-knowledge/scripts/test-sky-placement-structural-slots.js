...
const { buildFactGatedStructure, buildPacket, factStatusAllowsWriting, renderModelInput } = require(path.join(repoRoot, ".agents", "skills", "owner-author-writer", "scripts", "compile-writing-packet.js"));
