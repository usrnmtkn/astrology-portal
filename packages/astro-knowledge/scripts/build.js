...
function build() {
  ...
  const timingEventSources = loadEntries("timing");
  ...
  for (const entry of timingEventSources) addEntry(index, entry, "timing/source");
  ...
  const counts = {
    ...
    timingEventSources: timingEventSources.length,
