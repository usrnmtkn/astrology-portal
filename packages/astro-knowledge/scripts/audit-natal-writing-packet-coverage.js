...
const { buildIndex, repoRoot } = require("../../../.agents/skills/owner-author-writer/scripts/build-voice-index.js");
const { buildNatalWritingPacket, houseNumber } = require("../../../.agents/skills/owner-author-writer/scripts/natal-writing-packet.js");

const sourcePath = path.join(repoRoot, "packages", "astro-knowledge", "voice", "tldr-astro", "owner-author-writer", "ll-matrix-v13", "ll-matrix-v13.json");
