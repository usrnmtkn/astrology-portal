...
function main() {
  ...
  assert.match(writerPolicy.voiceTarget.permanentRule, /Warmth and a natural cadence are acceptable/);
  ...
  assert.match(judgePrompt, /\[CF-016\].*Warmth, tenderness/);
  ...
  assert.match(skill, /Marie's writing determines both the delivery and what the article notices/);
