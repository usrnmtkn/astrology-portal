...
function materializeEntry(sourceRoot, cohortName, selection, check) {
  ...
  const expectedUrl = `https://private-author-source.invalid/blogs/astrology/${selection.slug}`;
...
function buildManifest(sourceRoot, check) {
  ...
  return {
    ...
    provenance: "owner-published Project Author article bodies extracted from the owner-provided SiteSucker mirror",
