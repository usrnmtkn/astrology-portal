...
const { buildIndex } = require("../../../.agents/skills/owner-author-writer/scripts/build-voice-index.js");
const {
  eligibleEntries,
  selectSix,
  structureFor
} = require("../../../.agents/skills/owner-author-writer/scripts/compile-writing-packet.js");
...
function judgePrompt(cards) {
  return [
    ...
    "Score 3 when the card is immediately clear, natural, event-specific, concrete, and recognizably Project Author in sentence movement.",
