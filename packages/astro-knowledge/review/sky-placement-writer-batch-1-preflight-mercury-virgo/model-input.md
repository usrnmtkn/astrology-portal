...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "With Mercury in Virgo, your thoughts are analytical, detailed, and practical. You excel at problem - solving and critical thinking. You communicate clearly, logically, and you’re good at giving useful advice.",
  "combinedMeaning": "With Mercury in Virgo, Mercury is at home and exalted, so thinking can be clear, practical, and exact. You communicate best when details matter and improvement is possible.",
  "collectiveGift": "Mercury in Virgo: the mind is precise, analytical, and built for useful discernment.",
  "observableShadowBehaviors": [
    "Overcriticism",
    "worry",
    "using detail as a shield against action"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/mercury-virgo.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Mercury in Virgo, Mercury is at home and exalted, so thinking can be clear, practical, and exact. You communicate best when details matter and improvement is possible."
    },
    {
...
Words: patterns, home, life, trying, stop, work, needs, self, keep, real.
...
EXACT TASK
Write one complete continuous Current Sky fallback article for Mercury in Virgo. Create one recognizable lived sequence from the verified astrology. Return only opening, tension, development, close, and try_this.
...
OWNER PASSAGE 4
And once seen, it cannot be unseen. Watch for inconsistencies. The silence after the lie lands. The shift in atmosphere when the truth refuses to stay buried.
