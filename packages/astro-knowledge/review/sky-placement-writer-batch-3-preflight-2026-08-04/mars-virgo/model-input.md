...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "With Mars in Virgo, you act with precision and practicality. You have an acute eye for detail and a desire for perfection. Your energy is applied in service, organization, and tasks that require meticulous attention.",
  "combinedMeaning": "With Mars in Virgo, drive works through problem-solving, technique, and practical correction. You act by fixing what is broken and refining what can be better.",
  "collectiveGift": "Mars in Virgo: action is precise, efficient, and aimed at improvement.",
  "observableShadowBehaviors": [
    "Criticism",
    "anxiety",
    "burning energy on flaws instead of priorities"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/mars-virgo.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Mars in Virgo, drive works through problem-solving, technique, and practical correction. You act by fixing what is broken and refining what can be better."
    },
    {
...
{
  "priorSign": "leo",
  "priorSignEntryDate": "September 27, 2026",
  "priorSignExitDate": "November 25, 2026",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-mars-square-uranus-2026-12-04t19:28:16.999z",
      "date": "December 4, 2026",
      "body": "mars-square-uranus",
      "eventType": "exact-aspect",
      "meaning": "Action meets disruption. Impulsive, risk-taking, rebellious energy, with impatience and a pull toward technology. Psychologically the square is inner tension to integrate: Accident-proneness, a temper that goes off like a shot, and unpredictable tactics that either win big or backfire fast. The growth is owning both sides instead of splitting them.",
      "meaningSource": "packages/astro-knowledge/data/transits/mars-square-uranus.json"
    },
    {
      "id": "aspect-venus-square-mars-2027-01-16t21:37:39.999z",
      "date": "January 16, 2027",
      "body": "mars-square-venus",
      "eventType": "exact-aspect",
...
{
  "sign": "virgo",
  "entryDate": "June 17, 2025",
  "exitDate": "August 6, 2025",
  "renderTokens": {
...
Words: needs, instead, life, keep, work, trying, stop, real, self, action.
...
EXACT TASK
Write one complete continuous Current Sky fallback article for Mars in Virgo. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
