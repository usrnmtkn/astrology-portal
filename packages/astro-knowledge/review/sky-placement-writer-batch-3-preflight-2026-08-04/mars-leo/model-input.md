...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "Mars in Leo gives you a flair for the dramatic. Your actions often attract attention, and you carry out your tasks with a sense of pride and a desire for recognition. Your energy levels are consistently high, and you face life with a courageous heart.",
  "combinedMeaning": "With Mars in Leo, drive wants expression, recognition, and a worthy stage. You act best when courage, play, and purpose are all involved.",
  "collectiveGift": "Mars in Leo: action is creative, bold, and fueled by pride in the work.",
  "observableShadowBehaviors": [
    "Ego battles",
    "drama",
    "confusing being seen with being respected"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/mars-leo.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Mars in Leo, drive wants expression, recognition, and a worthy stage. You act best when courage, play, and purpose are all involved."
    },
    {
...
{
  "priorSign": "cancer",
  "priorSignEntryDate": "August 11, 2026",
  "priorSignExitDate": "September 27, 2026",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-mars-trine-neptune-2026-10-02t22:17:44.999z",
      "date": "October 2, 2026",
      "body": "mars-trine-neptune",
      "eventType": "exact-aspect",
      "meaning": "Drive meets imagination. Energy steered by vision and a persuasive, magnetic pull. The trine makes this a natural strength: Charismatic motivation; action aligned with imagination. The growth edge is not to coast on the ease.",
      "meaningSource": "packages/astro-knowledge/data/transits/mars-trine-neptune.json"
    },
    {
      "id": "aspect-mars-sextile-uranus-2026-10-07t10:41:31.999z",
      "date": "October 7, 2026",
      "body": "mars-sextile-uranus",
      "eventType": "exact-aspect",
      "meaning": "Action meets disruption. Impulsive, risk-taking, rebellious energy, with impatience and a pull toward technology. The sextile makes this a natural strength: Quick, original action and inventive problem-solving. The growth edge is not to coast on the ease.",
      "meaningSource": "packages/astro-knowledge/data/transits/mars-sextile-uranus.json"
    }
  ]
}
...
{
  "sign": "leo",
  "entryDate": "April 18, 2025",
  "exitDate": "June 17, 2025",
  "renderTokens": {
...
Words: life, work, creative, attention, action, time, look, heart, worth, emotional.
...
EXACT TASK
Write one complete continuous Current Sky fallback article for Mars in Leo. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
