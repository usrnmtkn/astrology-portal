...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "With Mars in Gemini in your chart, your actions are powered by your intellect. Quick - thinking and versatility guide your moves. You may be drawn towards activities that involve communication, networking, or learning new skills.",
  "combinedMeaning": "With Mars in Gemini, drive is mental, verbal, and restless. You act by asking, debating, learning, and keeping options moving.",
  "collectiveGift": "Mars in Gemini: action moves through words, ideas, and quick adaptation.",
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/mars-gemini.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Mars in Gemini, drive is mental, verbal, and restless. You act by asking, debating, learning, and keeping options moving."
    },
    {
...
{
  "priorSign": "taurus",
  "priorSignEntryDate": "May 18, 2026",
  "priorSignExitDate": "June 28, 2026",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-mars-trine-pluto-2026-07-05t13:06:23.999z",
      "date": "July 5, 2026",
      "body": "mars-trine-pluto",
      "eventType": "exact-aspect",
      "meaning": "Drive meets power. Relentless force and a 'win at any cost' edge, with real capacity to eliminate or transform. The trine makes this a natural strength: Strength and stamina without the strain. The growth edge is not to coast on the ease.",
      "meaningSource": "packages/astro-knowledge/data/transits/mars-trine-pluto.json"
    },
    {
      "id": "aspect-mars-sextile-neptune-2026-07-05t00:44:26.999z",
      "date": "July 4, 2026",
...
{
  "sign": "gemini",
  "entryDate": "July 20, 2024",
  "exitDate": "September 4, 2024",
  "renderTokens": {
...
Words: learning, communication, moves, need, action, stop, let, asking, work, brings.
...
EXACT TASK
Write one complete continuous Current Sky fallback article for Mars in Gemini. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
