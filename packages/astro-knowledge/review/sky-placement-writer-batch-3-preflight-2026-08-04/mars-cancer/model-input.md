...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "When Mars is in Cancer, your actions are motivated by emotion and intuition. You protect what you hold dear with a fierce determination. While you may approach situations cautiously, once you commit, you invest deep emotional energy.",
  "combinedMeaning": "With Mars in Cancer, drive is motivated by care, loyalty, and the need to defend what matters. Mars is in fall here, so anger can turn sideways until it is named directly.",
  "collectiveGift": "Mars in Cancer: action is protective, emotional, and indirect when unsafe.",
  "observableShadowBehaviors": [
    "Passive aggression",
    "defensiveness",
    "acting from hurt before you admit you are hurt"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/mars-cancer.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Mars in Cancer, drive is motivated by care, loyalty, and the need to defend what matters. Mars is in fall here, so anger can turn sideways until it is named directly."
    },
    {
...
{
  "priorSign": "gemini",
  "priorSignEntryDate": "June 28, 2026",
  "priorSignExitDate": "August 11, 2026",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-mars-square-neptune-2026-08-17t09:52:37.999z",
      "date": "August 17, 2026",
      "body": "mars-square-neptune",
      "eventType": "exact-aspect",
      "meaning": "Drive meets imagination. Energy steered by vision and a persuasive, magnetic pull. Psychologically the square is inner tension to integrate: Misdirected effort: setting off one way and ending up another, with energy quietly draining away. The growth is owning both sides instead of splitting them.",
      "meaningSource": "packages/astro-knowledge/data/transits/mars-square-neptune.json"
    },
    {
      "id": "aspect-mars-square-saturn-2026-09-01t09:58:39.999z",
      "date": "September 1, 2026",
      "body": "mars-square-saturn",
      "eventType": "exact-aspect",
      "meaning": "Drive meets limit. Disciplined endurance and the ability to pace yourself and keep going long after others quit. Psychologically the square is inner tension to integrate: Gas and brake at once: jerky, stop-start progress, frustration, and a need to avoid burning bridges in case of retreat. The growth is owning both sides instead of splitting them.",
      "meaningSource": "packages/astro-knowledge/data/transits/mars-square-saturn.json"
    }
  ]
}
...
{
  "sign": "cancer",
  "entryDate": "January 6, 2025",
  "exitDate": "April 18, 2025",
  "renderTokens": {
...
Words: emotional, action, need, care, deep, move, felt, fire, time, life.
Owner phrase evidence: None selected for this placement.

EXACT TASK
Write one complete continuous Current Sky fallback article for Mars in Cancer. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
