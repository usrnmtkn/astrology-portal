...
DIRECTION: {{holder1}} is always the Pluto holder. {{holder2}} is always the Ascendant holder. The Pluto holder acts on how the Ascendant holder presents themselves and enters situations.
...
Approved human-moment semantic input: {{holder2}} can show more of themselves around {{holder1}} without immediately feeling exposed. The connection grows deeper without {{holder2}} having to stay guarded.
...
[1] (libra-new-moon) The stars are bringing insights about your psychological patterns that can create healing and understanding, and your spiritual understanding of love is expanding beyond possession and control.
[2] (cancer-full-moon-horoscopes-january-2025) When everything feels divided, showing up for connection is a radical way to heal, rebuild, and remind one another that we are stronger together.
[3] (cancer-new-moon-2025) And as missiles fall on bunkers once built for protection, we're being shown, in real time, what happens when safety is rooted in secrecy and control.
...
- body_you: the reader is {{holder1}}, so refer to the Pluto holder as 'you' and keep the Ascendant holder as {{holder2}}.
- body_they: the reader is {{holder2}}, so keep the Pluto holder as {{holder1}} and refer to the Ascendant holder as 'you'.
