...
TARGET: Neptune -> Ascendant, soft
DIRECTION: {{holder1}} is always the Neptune holder. {{holder2}} is always the Ascendant holder. The Neptune holder acts on how the Ascendant holder presents themselves and enters situations.

GOVERNED MEANING BOUNDARY
plainTranslation: Their idealism, vagueness, and dreams work smoothly with how freely you present yourself and enter situations.
summaryDeep: Their idealism, vagueness, and dreams work smoothly with how freely you present yourself and enter situations. It runs easily and asks little, quietly steadying the rest of the bond. Lean on how naturally this one lines up.
Approved human-moment semantic input: {{holder1}} sees {{holder2}} with kindness and gives them room to relax. Around {{holder1}}, {{holder2}} does not have to work so hard to be understood.
...
- body_you: the reader is {{holder1}}, so refer to the Neptune holder as 'you' and keep the Ascendant holder as {{holder2}}.
- body_they: the reader is {{holder2}}, so keep the Neptune holder as {{holder1}} and refer to the Ascendant holder as 'you'.
