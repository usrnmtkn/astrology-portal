...
VERIFIED ASTROLOGY
{
  "planetFunction": "Saturn describes time, structure, boundaries, maturity, responsibility, limits, discipline, and the lessons that ask someone to become more capable and realistic. It shows where life may move slowly, but also where lasting strength can be built.",
  "signExpression": "When Saturn resides in Aries, your life lessons center around self-assertion and individuality. Discipline and patience become tools you need to master to overcome impulsive actions. You learn to cultivate the courage to take the lead and stand up for yourself without being overly confrontational.",
  "combinedMeaning": "With Saturn in Aries, Saturn is in fall, so discipline and initiative start out at odds; the work is developing initiative without recklessness and authority without constant combat. Patience becomes the tool that makes courage sustainable.",
  "collectiveGift": "Saturn in Aries: discipline must be learned through courage and self-direction.",
  "observableShadowBehaviors": [
    "Blocked assertion",
    "harshness",
    "or forcing independence because vulnerability feels unsafe"
  ],
  "timing": "Saturn takes about twenty-nine years to move through all twelve signs and spends roughly two and a half years in each sign. Its sign describes the style of the lesson; its house shows where commitment, pressure, and mastery develop over time.",
  "supportedDomains": [],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/saturn-aries.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Saturn in Aries, Saturn is in fall, so discipline and initiative start out at odds; the work is developing initiative without recklessness and authority without constant combat. Patience becomes the tool that makes courage sustainable."
    },
    {
      "sourcePath": "packages/astro-knowledge/data/planetary/saturn.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "Saturn describes time, structure, boundaries, maturity, responsibility, limits, discipline, and the lessons that ask someone to become more capable and realistic. It shows where life may move slowly, but also where lasting strength can be built. Saturn takes about twenty-nine years to move through all twelve signs and spends roughly two and a half years in each sign. Its sign describes the style of the lesson; its house shows where commitment, pressure, and mastery develop over time. When Saturn resides in Aries, your life lessons center around self-assertion and individuality. Discipline and patience become tools you need to master to overcome impulsive actions. You learn to cultivate the courage to take the lead and stand up for yourself without being overly confrontational."
    }
  ],
  "validation": {
    "complete": true,
...
SURFACE REQUIREMENTS
{
  ...
  "pace": "about two and a half years"
}
...
BACKING FACTS
{
  ...
  "zodiacCircuit": "about 29 years",
  "typicalSignStay": "roughly 2.5 to 3 years per sign",
...
Words: life, self, learned, time, need, work, feels, ask, boundaries, start.
Owner phrase evidence: None selected for this placement.

EXACT TASK
Write one complete continuous Current Sky fallback article for Saturn in Aries. Create one recognizable lived sequence from the verified astrology. Return only opening, tension, development, close, and try_this.
...
OWNER PASSAGE 2
This is Aphrodite emerging from sea foam but insisting on solid ground to stand on. The goddess of love learning that the heart needs material support to keep beating, that even divine beauty requires earthly care.
