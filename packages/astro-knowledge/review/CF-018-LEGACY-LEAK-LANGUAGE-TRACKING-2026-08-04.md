...
CF-018 prohibits `leak`, `leaks`, `leaked`, and `leaking` in newly generated Project Author editorial copy. It remains active in the writer, linter, judge, vocabulary, and regression policies.
