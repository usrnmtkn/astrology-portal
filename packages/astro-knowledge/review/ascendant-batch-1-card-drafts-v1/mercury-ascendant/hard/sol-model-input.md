...
TARGET: Mercury -> Ascendant, hard
DIRECTION: {{holder1}} is always the Mercury holder. {{holder2}} is always the Ascendant holder. The Mercury holder acts on how the Ascendant holder presents themselves and enters situations.

GOVERNED MEANING BOUNDARY
plainTranslation: Their questions, explanations, and way of talking press against how freely you present yourself and enter situations.
summaryDeep: Their questions, explanations, and way of talking press against how freely you present yourself and enter situations. It catches often enough that you both feel it, and it keeps asking to be worked out. Name it directly instead of letting it build in silence.
Approved human-moment semantic input: {{holder1}}'s questions and comments can make {{holder2}} feel picked apart, so {{holder2}} starts explaining or defending themselves instead of acting naturally.
...
- body_you: the reader is {{holder1}}, so refer to the Mercury holder as 'you' and keep the Ascendant holder as {{holder2}}.
- body_they: the reader is {{holder2}}, so keep the Mercury holder as {{holder1}} and refer to the Ascendant holder as 'you'.
...
WARMTH RECORD
This is a none_found packet. Return warmthSource as null and labels as an empty array. Do not invent a permission, reassurance, benediction, or other warmth line.
