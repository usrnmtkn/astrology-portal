...
DIRECTION: {{holder1}} is always the Sun holder. {{holder2}} is always the Ascendant holder. The Sun holder acts on how the Ascendant holder presents themselves and enters situations.
...
Approved human-moment semantic input: {{holder1}}'s confidence helps {{holder2}} feel more comfortable being themselves when they meet people or enter a new situation.
...
- body_you: the reader is {{holder1}}, so refer to the Sun holder as 'you' and keep the Ascendant holder as {{holder2}}.
- body_they: the reader is {{holder2}}, so keep the Sun holder as {{holder1}} and refer to the Ascendant holder as 'you'.
