...
TARGET: Venus -> Ascendant, soft
DIRECTION: {{holder1}} is always the Venus holder. {{holder2}} is always the Ascendant holder. The Venus holder acts on how the Ascendant holder presents themselves and enters situations.

GOVERNED MEANING BOUNDARY
plainTranslation: Their affection, preferences, and wish to keep things pleasant work smoothly with how freely you present yourself and enter situations.
summaryDeep: Their affection, preferences, and wish to keep things pleasant work smoothly with how freely you present yourself and enter situations. It runs easily and asks little, quietly steadying the rest of the bond. Lean on how naturally this one lines up.
Approved human-moment semantic input: {{holder1}} likes {{holder2}} as they are, and that makes {{holder2}} feel more relaxed and comfortable around {{holder1}}.
...
- body_you: the reader is {{holder1}}, so refer to the Venus holder as 'you' and keep the Ascendant holder as {{holder2}}.
- body_they: the reader is {{holder2}}, so keep the Venus holder as {{holder1}} and refer to the Ascendant holder as 'you'.
