...
TARGET: Moon -> Ascendant, soft
DIRECTION: {{holder1}} is always the Moon holder. {{holder2}} is always the Ascendant holder. The Moon holder acts on how the Ascendant holder presents themselves and enters situations.

GOVERNED MEANING BOUNDARY
plainTranslation: Their moods, needs, and habits of comfort work smoothly with how freely you present yourself and enter situations.
summaryDeep: Their moods, needs, and habits of comfort work smoothly with how freely you present yourself and enter situations. It runs easily and asks little, quietly steadying the rest of the bond. Lean on how naturally this one lines up.
Approved human-moment semantic input: Around {{holder1}}, {{holder2}} can relax and show how they feel without worrying that it will become a problem.
...
- body_you: the reader is {{holder1}}, so refer to the Moon holder as 'you' and keep the Ascendant holder as {{holder2}}.
- body_they: the reader is {{holder2}}, so keep the Moon holder as {{holder1}} and refer to the Ascendant holder as 'you'.
