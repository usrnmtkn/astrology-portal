...
Approved human-moment semantic input: {{holder1}} notices {{holder2}}'s mood almost immediately, which can feel comforting when {{holder2}} wants to be understood and exposing when {{holder2}} wants privacy.
