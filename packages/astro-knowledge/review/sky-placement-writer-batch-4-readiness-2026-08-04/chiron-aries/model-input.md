...
VERIFIED ASTROLOGY
{
  "planetFunction": "Chiron describes the wound that teaches: the tender place where an early, unearned hurt shaped a survival response, and where healing turns private pain into the ability to help others carry theirs. In the myth Chiron is the wounded healer, the mentor whose own injury never fully closes, and the talent often grows from the same place as the wound. A slow-moving body orbiting between Saturn and Uranus, it works the bridge between what structure can hold and what has to change. Chiron does not promise that the wound disappears; it shows how to carry it differently.",
  "signExpression": "With Chiron in Aries, the wound sits in the sense of self: wanting things, going first, and existing without apology. Healing works through acting anyway and learning that the discomfort can be survived.",
  "combinedMeaning": "With Chiron in Aries, the tender spot is the sense of self: wanting things, going first, and existing without apology. Healing works through acting anyway and learning that the discomfort can be survived.",
  "collectiveGift": "Chiron in Aries: the wound sits in identity, assertion, and the right to take up space.",
  "observableShadowBehaviors": [
    "Freezing at the moment of assertion",
    "or overcorrecting into aggression to cover the freeze"
  ],
  "timing": "Chiron takes about fifty years to move through all twelve signs, spending roughly four to nine years in each because its orbit is elliptical. Its yearly retrograde is a regular pause for repair, and its return near age fifty marks a life-defining review of the wound and what it taught.",
  "supportedDomains": [
    "identity",
    "assertion",
    "self-worth",
    "taking up space",
    "courage",
    "healing and repair (wound language is literal here and licensed)"
  ],
  "unsupportedDomainWarnings": [
    "no medical claims; career and money are not the main domain."
  ],
  ...
  "scenarioPolicy": "The writer may create related lived moments by combining the governed planet and sign meanings inside the supported domains. The transit remains the subject, and no single invented scenario may carry the whole card. The moments may be invented; the astrology may not. generational wound carried in one recognizable person-scale moment.",
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/chiron-aries.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Chiron in Aries, the tender spot is the sense of self: wanting things, going first, and existing without apology. Healing works through acting anyway and learning that the discomfort can be survived."
    },
    {
      "sourcePath": "packages/astro-knowledge/data/planetary/chiron.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "Chiron describes the wound that teaches: the tender place where an early, unearned hurt shaped a survival response, and where healing turns private pain into the ability to help others carry theirs. In the myth Chiron is the wounded healer, the mentor whose own injury never fully closes, and the talent often grows from the same place as the wound. A slow-moving body orbiting between Saturn and Uranus, it works the bridge between what structure can hold and what has to change. Chiron does not promise that the wound disappears; it shows how to carry it differently. Chiron takes about fifty years to move through all twelve signs, spending roughly four to nine years in each because its orbit is elliptical. Its yearly retrograde is a regular pause for repair, and its return near age fifty marks a life-defining review of the wound and what it taught. With Chiron in Aries, the wound sits in the sense of self: wanting things, going first, and existing without apology. Healing works through acting anyway and learning that the discomfort can be survived."
    }
  ],
  "validation": {
    "complete": true,
...
SURFACE REQUIREMENTS
{
  ...
  "pace": "years in a sign, four to nine depending on the stretch"
}
...
{
  "priorSign": "taurus",
  "priorSignEntryDate": "June 19, 2026",
  "priorSignExitDate": "September 17, 2026",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  ...
  "zodiacCircuit": "about 50 years",
  "typicalSignStay": "roughly 4 to 9 years per sign",
  "variabilityNote": "Chiron has an elliptical orbit, so sign residency varies."
}
...
{
  "sign": "aries",
  "entryDate": "February 18, 2019",
  "exitDate": "June 19, 2026",
  "renderTokens": {
...
Emotional core: the wound feels like identity
Primary foundation: Chiron does not promise that the wound disappears. It shows us how to carry it differently.

Alternate foundation: The wound does not define us, but the way we carry it does.
...
Words: self, space, learning, worth, place, body, moment, moving, change, ability.
Owner phrase evidence: None selected for this placement.

EXACT TASK
Write one complete continuous Current Sky fallback article for Chiron in Aries. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
...
OWNER PASSAGE 2
Not erased, but released. Chiron doesn’t promise that the wound disappears. It shows us how to carry it differently, so that healing is not about forgetting, but about reclaiming power from what once defined us.
...
OWNER PASSAGE 6
It’s the water-bearer’s task to hold the emotional weight of transformation while pouring out the healing waters of change. When Pluto and Mercury meet the Sun and Moon under this lunation, they amplify their power. Mercury also reminds us that words are powerful.
