...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "If Mars is in Sagittarius, your actions embody an adventurous spirit. You relish taking risks and exploring new frontiers. Guided by optimism and enthusiasm, you’re always prepared for the next big adventure.",
  "combinedMeaning": "With Mars in Sagittarius, drive moves toward exploration, truth, risk, and the next horizon. You act when something feels meaningful enough to chase.",
  "collectiveGift": "Mars in Sagittarius: action is adventurous, candid, and motivated by belief.",
  "observableShadowBehaviors": [
    "Recklessness",
    "bluntness",
    "acting from belief before checking the facts"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/mars-sagittarius.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Mars in Sagittarius, drive moves toward exploration, truth, risk, and the next horizon. You act when something feels meaningful enough to chase."
    },
    {
...
{
  "priorSign": "scorpio",
  "priorSignEntryDate": "September 1, 2027",
  "priorSignExitDate": "October 15, 2027",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-mars-sextile-pluto-2027-10-22t14:34:05.999z",
      "date": "October 22, 2027",
      "body": "mars-sextile-pluto",
      "eventType": "exact-aspect",
      "meaning": "Drive meets power. Relentless force and a 'win at any cost' edge, with real capacity to eliminate or transform. The sextile makes this a natural strength: Strength and stamina without the strain. The growth edge is not to coast on the ease.",
      "meaningSource": "packages/astro-knowledge/data/transits/mars-sextile-pluto.json"
    },
    {
      "id": "aspect-mars-trine-neptune-2027-10-22t09:31:55.999z",
      "date": "October 22, 2027",
...
{
  "sign": "sagittarius",
  "entryDate": "November 4, 2025",
  "exitDate": "December 15, 2025",
  "renderTokens": {
...
Words: action, truth, move, needs, feels, horizon, always, fire, life, time.
Owner phrase evidence: None selected for this placement.

EXACT TASK
Write one complete continuous Current Sky fallback article for Mars in Sagittarius. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
