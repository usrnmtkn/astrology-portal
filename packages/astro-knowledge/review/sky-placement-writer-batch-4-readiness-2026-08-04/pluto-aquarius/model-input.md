...
VERIFIED ASTROLOGY
{
  "planetFunction": "Pluto describes deep change, power, control, fear, survival, compulsion, hidden material, and the process of confronting what can no longer stay buried. It shows where life asks for honesty, release, and transformation at the root.",
  "signExpression": "Represents a generation with transformative experiences in the realms of innovation, technology, and societal change. This placement can bring transformations in areas related to progress, revolution, and collective consciousness.",
  "combinedMeaning": "With Pluto in Aquarius, deep change works on systems: who holds power, how groups organize, and what technology does to both. The transformation is generational rather than personal.",
  "collectiveGift": "Pluto in Aquarius: power transforms through networks, technology, and collective structures.",
  "observableShadowBehaviors": [
    "Ideological control",
    "the group swallowing the person",
    "revolution that reproduces the old power"
  ],
  "timing": "Pluto moves very slowly, spending many years in each sign. Its house transits mark long chapters of pressure, excavation, ending, renewal, and the gradual transformation of a life area.",
  "supportedDomains": [
    "power",
    "systems",
    "groups and networks",
    "technology's effect on both",
    "generational change"
  ],
  "unsupportedDomainWarnings": [
    "do not make personal money, career, or romance the main domain; no named political events."
  ],
  ...
  "scenarioPolicy": "The writer may create related lived moments by combining the governed planet and sign meanings inside the supported domains. The transit remains the subject, and no single invented scenario may carry the whole card. The moments may be invented; the astrology may not. era scale; the group and the person inside it.",
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/pluto-aquarius.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Pluto in Aquarius, deep change works on systems: who holds power, how groups organize, and what technology does to both. The transformation is generational rather than personal."
    },
    {
      "sourcePath": "packages/astro-knowledge/data/planetary/pluto.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "Pluto describes deep change, power, control, fear, survival, compulsion, hidden material, and the process of confronting what can no longer stay buried. It shows where life asks for honesty, release, and transformation at the root. Pluto moves very slowly, spending many years in each sign. Its house transits mark long chapters of pressure, excavation, ending, renewal, and the gradual transformation of a life area. Represents a generation with transformative experiences in the realms of innovation, technology, and societal change. This placement can bring transformations in areas related to progress, revolution, and collective consciousness."
    }
  ],
  "validation": {
    "complete": true,
...
{
  "priorSign": "capricorn",
  "priorSignEntryDate": "September 1, 2024",
...
BACKING FACTS
{
  ...
  "zodiacCircuit": "about 248 years",
  "typicalSignStay": "roughly 12 to 31 years per sign",
  "variabilityNote": "Pluto has an elliptical orbit, so its time in each sign varies widely. The current sign range must come from the calculation rather than the average residency."
}
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-neptune-sextile-pluto-2026-07-25t05:26:37.999z",
      "date": "July 25, 2026",
      "body": "pluto-sextile-neptune",
      "eventType": "exact-aspect",
      "meaning": "Imagination meets power. A deep generational signature: intensified collective imagination and transformation. The sextile makes this a natural strength: Heightened collective vision. The growth edge is not to coast on the ease.",
      "meaningSource": "packages/astro-knowledge/data/transits/neptune-sextile-pluto.json"
    },
    {
      "id": "aspect-uranus-trine-pluto-2026-07-18t04:43:21.999z",
      "date": "July 18, 2026",
      "body": "pluto-trine-uranus",
      "eventType": "exact-aspect",
      "meaning": "Disruption meets power. Upheaval and radical transformation, often tied to social change; quick adaptation to new technology. The trine makes this a natural strength: Fast, effective adaptation to change. The growth edge is not to coast on the ease.",
      "meaningSource": "packages/astro-knowledge/data/transits/uranus-trine-pluto.json"
    }
  ]
}
...
{
  "sign": "aquarius",
  "entryDate": "March 23, 2023",
  "exitDate": "June 11, 2023",
  "renderTokens": {
...
- shadow-parallel-run: The turn may use two or three parallel 'the way X becomes Y' clauses, never more.
  Owner example: The way perfectionism becomes protection against criticism, the way busy-ness becomes a hedge against feeling, the way fixing others becomes an escape from our own healing.
...
Words: power, change, asks, deep, life, let, look, time, trust, moment.
Owner phrase evidence: “focus shifts”; “personal life”; “material security”. Use sparingly and do not build the paragraph around a phrase.

EXACT TASK
Write one complete continuous Current Sky fallback article for Pluto in Aquarius. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
...
OWNER PASSAGE 3
Media literacy isn't enough anymore when the boundary between authentic and artificial keeps shifting. Social networks that promised connection deliver isolation. Search engines that promised knowledge deliver manipulation.
...
OWNER PASSAGE 5
Aquarius demands progress over perfection, urging us to confront the systems we’ve built, not just in our own lives, but in the foundations of society itself. It asks the hard questions: Are these structures serving a greater purpose, or are they perpetuating stagnation and inequality? With Pluto in the mix, this New Moon pulls no punches.

OWNER PASSAGE 6
Leo wants loyalty and admiration, but in the seventh house, that energy can get twisted into power games. Stop pretending everything’s fine if it’s not.
