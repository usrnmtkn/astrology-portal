...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "With Mars in Pisces, your actions are motivated by your empathy and intuition. You have a selfless desire to help and heal. Your actions might be guided by your deep spiritual beliefs or a strong sense of creative inspiration.",
  "combinedMeaning": "With Mars in Pisces, drive moves through feeling, imagination, service, and spiritual pull. Energy needs meaning and clear boundaries or it disperses.",
  "collectiveGift": "Mars in Pisces: action is intuitive, compassionate, and indirect.",
  "observableShadowBehaviors": [
    "Avoidance",
    "confusion",
    "martyrdom",
    "anger that comes out sideways instead of being spoken plainly"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/mars-pisces.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Mars in Pisces, drive moves through feeling, imagination, service, and spiritual pull. Energy needs meaning and clear boundaries or it disperses."
    },
    {
...
{
  "priorSign": "aquarius",
  "priorSignEntryDate": "January 3, 2028",
  "priorSignExitDate": "February 10, 2028",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-mars-square-uranus-2028-02-18t04:55:17.999z",
      "date": "February 17, 2028",
...
{
  "sign": "pisces",
  "entryDate": "March 2, 2026",
  "exitDate": "April 9, 2026",
  "renderTokens": {
...
Words: needs, moves, time, feeling, worth, forward, past, action, let, old.
...
EXACT TASK
Write one complete continuous Current Sky fallback article for Mars in Pisces. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
