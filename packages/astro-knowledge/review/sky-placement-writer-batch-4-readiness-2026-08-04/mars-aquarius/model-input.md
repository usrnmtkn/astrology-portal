...
VERIFIED ASTROLOGY
{
  "planetFunction": "Mars describes action, drive, heat, conflict, courage, desire, and the instinct to move toward what is wanted. It shows how someone fights, initiates, protects, reacts, and uses energy when something needs to happen.",
  "signExpression": "Mars in Aquarius bestows upon you a unique, innovative drive. You act based on your strong ideals and are willing to challenge the status quo. You may be drawn towards activities that benefit society as a whole or involve cutting-edge technology.",
  "combinedMeaning": "With Mars in Aquarius, drive moves through ideas, networks, and the urge to break stale patterns. You act when the future needs a different structure.",
  "collectiveGift": "Mars in Aquarius: action is principled, independent, and system-disrupting.",
  "observableShadowBehaviors": [
    "Detachment",
    "stubborn contrarianism",
    "fighting the system while ignoring the person in front of you"
  ],
  "timing": "Mars takes close to two years to move through all twelve signs, with retrograde periods that slow or redirect momentum. Its sign describes the style of action; its house shows where pressure, effort, and courage become active.",
  "supportedDomains": [],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/mars-aquarius.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Mars in Aquarius, drive moves through ideas, networks, and the urge to break stale patterns. You act when the future needs a different structure."
    },
    {
      "sourcePath": "packages/astro-knowledge/data/planetary/mars.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "Mars describes action, drive, heat, conflict, courage, desire, and the instinct to move toward what is wanted. It shows how someone fights, initiates, protects, reacts, and uses energy when something needs to happen. Mars takes close to two years to move through all twelve signs, with retrograde periods that slow or redirect momentum. Its sign describes the style of action; its house shows where pressure, effort, and courage become active. Mars in Aquarius bestows upon you a unique, innovative drive. You act based on your strong ideals and are willing to challenge the status quo. You may be drawn towards activities that benefit society as a whole or involve cutting-edge technology."
    }
  ],
  "validation": {
    "complete": true,
...
{
  "priorSign": "capricorn",
  "priorSignEntryDate": "November 25, 2027",
  "priorSignExitDate": "January 3, 2028",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  ...
  "zodiacCircuit": "about 2 years",
  "typicalSignStay": "roughly 6 to 7 weeks per sign",
  "variabilityNote": "A retrograde can extend one sign residency to about 7 months."
}
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-mars-sextile-neptune-2028-01-08t19:06:55.999z",
      "date": "January 8, 2028",
      "body": "mars-sextile-neptune",
      "eventType": "exact-aspect",
      "meaning": "Drive meets imagination. Energy steered by vision and a persuasive, magnetic pull. The sextile makes this a natural strength: Charismatic motivation; action aligned with imagination. The growth edge is not to coast on the ease.",
      "meaningSource": "packages/astro-knowledge/data/transits/mars-sextile-neptune.json"
    },
    {
      "id": "aspect-mars-trine-uranus-2028-01-11t18:47:12.999z",
      "date": "January 11, 2028",
      "body": "mars-trine-uranus",
      "eventType": "exact-aspect",
      "meaning": "Action meets disruption. Impulsive, risk-taking, rebellious energy, with impatience and a pull toward technology. The trine makes this a natural strength: Quick, original action and inventive problem-solving. The growth edge is not to coast on the ease.",
      "meaningSource": "packages/astro-knowledge/data/transits/mars-trine-uranus.json"
    }
  ]
}
...
{
  "sign": "aquarius",
  "entryDate": "January 23, 2026",
  "exitDate": "March 2, 2026",
  "renderTokens": {
...
Words: needs, look, let, time, life, asks, power, action, moment, trust.
...
EXACT TASK
Write one complete continuous Current Sky fallback article for Mars in Aquarius. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
...
OWNER PASSAGE 3
At first, it may have felt like just another push to keep going, to keep proving, to keep grinding. But then, something shifted.
