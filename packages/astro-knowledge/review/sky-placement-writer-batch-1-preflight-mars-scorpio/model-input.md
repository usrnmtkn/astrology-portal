...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "You act with intensity and a strong will. Your actions are often guided by your deep intuition, and you’re not afraid to explore the hidden depths of any situation.",
  "combinedMeaning": "With Mars in Scorpio, Mars is at home, so drive moves through depth, endurance, and the willingness to confront what others avoid. Energy becomes powerful when trust and purpose are clear.",
  "collectiveGift": "Mars in Scorpio: action is intense, strategic, and deeply focused.",
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/mars-scorpio.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Mars in Scorpio, Mars is at home, so drive moves through depth, endurance, and the willingness to confront what others avoid. Energy becomes powerful when trust and purpose are clear."
    },
    {
...
Words: action, home, deep, trust, move, needs, felt, fire, time, life.
Owner phrase evidence: None selected for this placement.

EXACT TASK
Write one complete continuous Current Sky fallback article for Mars in Scorpio. Create one recognizable lived sequence from the verified astrology. Return only opening, tension, development, close, and try_this.
