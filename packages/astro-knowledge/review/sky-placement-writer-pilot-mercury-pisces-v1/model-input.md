...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "With Mercury in Pisces, your communication is empathetic, imaginative, and intuitive. Your thinking process is often influenced by your feelings. You’re good at expressing ideas creatively and understanding others on an emotional level.",
  "combinedMeaning": "With Mercury in Pisces, communication moves through images, feeling, dreams, and impression. Mercury is in detriment and fall here, so clarity needs extra structure.",
  "collectiveGift": "Mercury in Pisces: the mind is intuitive, poetic, and porous to subtle information.",
  "observableShadowBehaviors": [
    "Confusion",
    "avoidance",
    "mixed signals",
    "or letting emotion blur the facts"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/mercury-pisces.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Mercury in Pisces, communication moves through images, feeling, dreams, and impression. Mercury is in detriment and fall here, so clarity needs extra structure."
    },
    {
...
Words: moves, clarity, feeling, time, need, let, old, worth, begins, past.
Owner phrase evidence: “old wounds”; “focus shifts”; “stop pretending”. Use sparingly and do not build the paragraph around a phrase.

EXACT TASK
Write one complete continuous Current Sky fallback article for Mercury in Pisces. Create one recognizable lived sequence from the verified astrology. Return only opening, tension, development, close, and try_this.
