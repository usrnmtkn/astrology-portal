...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "With Mars in Capricorn, your actions are driven by your ambition and discipline. You have a strong work ethic and the patience to achieve your long-term goals. You act with practicality, and a strong sense of responsibility.",
  "combinedMeaning": "With Mars in Capricorn, Mars is exalted, so drive can become focused, strategic, and remarkably effective. Energy works best when pointed toward a concrete goal.",
  "collectiveGift": "Mars in Capricorn: action is disciplined, ambitious, and built for results.",
  "observableShadowBehaviors": [
    "Ruthlessness",
    "overwork",
    "treating every goal like a mountain to conquer"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/mars-capricorn.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Mars in Capricorn, Mars is exalted, so drive can become focused, strategic, and remarkably effective. Energy works best when pointed toward a concrete goal."
    },
    {
...
Words: action, work, long, move, needs, treating, felt, fire, time, life.
Owner phrase evidence: None selected for this placement.

EXACT TASK
Write one complete continuous Current Sky fallback article for Mars in Capricorn. Create one recognizable lived sequence from the verified astrology. Return only opening, tension, development, close, and try_this.
