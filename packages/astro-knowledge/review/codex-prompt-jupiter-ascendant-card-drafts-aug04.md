...
Use the owner-author-writer contract and the packet's `promptBlock` as supplied. Constraints that
...
- All Project Author editorial decisions apply, including: no em dashes, the morning-reader test,
