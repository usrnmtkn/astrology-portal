...
Write one continuous article for the supplied fallback contract. The app supplies the headline, fact line, dates, and any approved aspect insert. Keep one central tension across every paragraph. The first sentence of the opening must stand alone as a clear, sendable recognition line. Name both the planet and the sign in the opening. Opening shows ordinary evidence. Tension names how the same strength creates a cost. Development continues that exact problem through practical choices. Close names one realistic choice before {{exitDate}}. Try this contains two or three specific actions that do not repeat the close. Write actions someone would actually say they took, not facilitation, negotiation, or project-management instructions.

When writing a planet's cycle, use the words "all twelve signs"; the word "zodiac" is banned.
...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "With Mars in Aries, you’re blessed with a surge of energy and assertiveness. You act with confidence and a pioneering spirit, eager to forge your own path. Quick decisions and rapid action are your signatures.",
  "combinedMeaning": "With Mars in Aries, Mars is at home, so drive moves cleanly through courage, initiative, and confrontation when needed. You do best when energy has a clear target.",
  "collectiveGift": "Mars in Aries: action is fast, direct, and naturally assertive.",
  "observableShadowBehaviors": [
    "Impatience",
    "aggression",
    "fighting before asking what the fight is for"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/mars-aries.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Mars in Aries, Mars is at home, so drive moves cleanly through courage, initiative, and confrontation when needed. You do best when energy has a clear target."
    },
    {
...
SURFACE REQUIREMENTS
{
  ...
  "compiledPolicySha256": "cee3782652a11e24e4d188e31c29ae7eb1f2f41be715deafd1f8462b1d667e16",
...
CYCLE-LINE
In the meaning beat, use one or two sentences teaching the planet's rhythm. Every number must come from planet-cycle-facts.json. Write 'all twelve signs'; the word 'zodiac' is banned. Do not write this slot for the Moon.
...
Words: action, moves, needs, asking, home, time, life, worth, felt, past.
Owner phrase evidence: None selected for this placement.

EXACT TASK
Write one complete continuous Current Sky fallback article for Mars in Aries. Create one recognizable lived sequence from the verified astrology. Return only opening, tension, development, close, and try_this.
