...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "Your actions are characterized by your desire for balance and harmony. You are motivated to act fairly, and you might find yourself in the role of a mediator. You may also have a knack for artistic pursuits.",
  "combinedMeaning": "With Mars in Libra, drive moves through negotiation, partnership, and social awareness. Mars is in detriment here, so direct action may get delayed by the need to keep balance.",
  "collectiveGift": "Mars in Libra: action is relational, strategic, and shaped by fairness.",
  "observableShadowBehaviors": [
    "Indecision",
    "approval-seeking",
    "conflict avoidance that becomes resentment"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/mars-libra.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Mars in Libra, drive moves through negotiation, partnership, and social awareness. Mars is in detriment here, so direct action may get delayed by the need to keep balance."
    },
    {
...
Words: balance, need, action, forward, emotional, relationships, rather, work, self, instead.
Owner phrase evidence: “keeping the peace”; “professional life”; “social circles”. Use sparingly and do not build the paragraph around a phrase.

EXACT TASK
Write one complete continuous Current Sky fallback article for Mars in Libra. Create one recognizable lived sequence from the verified astrology. Return only opening, tension, development, close, and try_this.
