...
- **Owner (Project Author):** decides everything. Only her explicit approval of exact wording changes
  approval status. Her line edits always win. She writes as Project Author; her published corpus is the
...
- Owner rulings: `packages/astro-knowledge/voice/tldr-astro/owner-author-owner-feedback-audit.md`
  (OV rules, CF conflicts, VB vocabulary banks). Read before writing anything.
- Editorial decisions (machine): `voice/tldr-astro/owner-author-editorial-decisions.yaml`.
...
- Owner corpus: `voice/tldr-astro/fixtures/sky-article-longform/owner-corpus/reference-surfaces/`
  plus `TLDR-Article-Edition-*-OWNER.md`. Books and mirrors (CC = .com, SD = spiritdaughter.com,
...
1. Ask the owner which surface, and what exists for it today (any current copy, any format model
   she likes - e.g. a  structural model, as with placements).
