...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "With Jupiter in Leo, you’re bestowed with an enhanced sense of creativity, charm, and leadership. You’re likely to shine in the spotlight and succeed in endeavors where your unique talents and charisma can be put on full display.",
  "combinedMeaning": "With Jupiter in Leo, expansion works through creativity, celebration, leadership, and the courage to be seen. What grows is whatever gets shared with an audience of any size.",
  "collectiveGift": "Jupiter in Leo: growth comes through visible self-expression, generosity, and creative confidence.",
  "observableShadowBehaviors": [
    "Pride",
    "overpromising",
    "measuring the work by the applause it gets"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/jupiter-leo.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Jupiter in Leo, expansion works through creativity, celebration, leadership, and the courage to be seen. What grows is whatever gets shared with an audience of any size."
    },
    {
...
Words: growth, work, self, creative, emotional, let, feel, need, care, time.
...
EXACT TASK
Write one complete continuous Current Sky fallback article for Jupiter in Leo. Create one recognizable lived sequence from the verified astrology. Return only opening, tension, development, close, and try_this.
