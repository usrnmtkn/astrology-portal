...
2. One Sol draft per target using the packet's promptBlock and the owner-author-writer contract.
   ...
   placeholder conventions must match the shipped Jupiter–Ascendant rows. All Project Author
