...
owner-author-writer reference implementation on two names. Align them on the same branch before
commit.
...
(`.agents/skills/owner-author-writer/scripts/compile-writing-packet.js`) emits flag objects. Convert
