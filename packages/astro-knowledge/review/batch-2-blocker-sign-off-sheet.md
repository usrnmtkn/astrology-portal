...
propose the engine rewrite for approval. ______
...
Decision B: add as written, DRAFT, then mark REVIEWED after this sign-off. ______
...
Decision C: add as written, DRAFT, then mark REVIEWED after this sign-off. ______
