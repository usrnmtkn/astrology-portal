...
DIRECTION: {{holder1}} is always the Mercury holder. {{holder2}} is always the Venus holder. The Mercury holder acts on the Venus holder's affection, preferences, and way of caring.
...
Approved human-moment semantic input: {{holder1}}'s style of talking and {{holder2}}'s style of showing love fit tightly together, so every conversation feels like a small form of affection.
...
[1] (cancer-full-moon-horoscopes-january-2025) When everything feels divided, showing up for connection is a radical way to heal, rebuild, and remind one another that we are stronger together.
[2] (full-moon-in-aries) We don't have to choose between being loved and being ourselves.
[3] (leo-full-moon-2025) Something unresolved in love, in money, in worth is calling for review.
...
- body_you: the reader is {{holder1}}, so refer to the Mercury holder as 'you' and keep the Venus holder as {{holder2}}.
- body_they: the reader is {{holder2}}, so keep the Mercury holder as {{holder1}} and refer to the Venus holder as 'you'.
