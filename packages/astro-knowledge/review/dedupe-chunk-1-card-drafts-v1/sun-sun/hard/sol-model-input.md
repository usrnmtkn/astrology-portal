...
TARGET: Sun -> Sun, hard
DIRECTION: {{holder1}} is always the Sun holder. {{holder2}} is always the Sun holder. The Sun holder acts on the Sun holder's sense of identity, confidence, and direction.

GOVERNED MEANING BOUNDARY
plainTranslation: A's identity meets B's identity. The square puts them in friction.
summaryDeep: Your core directions rub against each other, wanting different things at the same time. Respect can curdle into a contest of wills. Take turns being the one who's right.
Approved human-moment semantic input: Their core ways of moving through the world constantly bump into each other, leaving both feeling crowded and fighting for elbow room.
...
- body_you: the reader is {{holder1}}, so refer to the Sun holder as 'you' and keep the Sun holder as {{holder2}}.
- body_they: the reader is {{holder2}}, so keep the Sun holder as {{holder1}} and refer to the Sun holder as 'you'.
