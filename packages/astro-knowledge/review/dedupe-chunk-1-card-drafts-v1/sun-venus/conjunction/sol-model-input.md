...
Approved human-moment semantic input: {{holder2}} genuinely admires who {{holder1}} is, and {{holder1}} thrives on that warmth. The risk comes when {{holder1}} starts relying on that approval to feel valid.
