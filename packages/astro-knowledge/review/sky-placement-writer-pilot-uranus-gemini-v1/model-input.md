...
VERIFIED ASTROLOGY
{
  "planetFunction": "Uranus describes awakening, disruption, freedom, invention, rupture, surprise, and the part of life that refuses to stay trapped inside a stale pattern. It shows where someone needs room to change and where the old structure may no longer fit.",
  "signExpression": "Implies an innovative mind with unique communication styles. Those with this placement may invent or create revolutionary ideas in media, technology, or education.",
  "combinedMeaning": "With Uranus in Gemini, the urge to break from old patterns works through words, ideas, media, and daily connections. Conversations, news, and ways of learning become the places where the familiar gets disrupted. (Modern planet; no traditional dignity.)",
  "collectiveGift": "Uranus in Gemini: change arrives through language, learning, and how information moves.",
  "observableShadowBehaviors": [
    "Restlessness",
    "scattered attention",
    "changing the subject instead of finishing the thought"
  ],
  "timing": "Uranus takes about eighty-four years to move through all twelve signs and spends about seven years in each sign. Its house transits mark longer chapters of change, liberation, instability, and new possibility.",
  "supportedDomains": [],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/uranus-gemini.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Uranus in Gemini, the urge to break from old patterns works through words, ideas, media, and daily connections. Conversations, news, and ways of learning become the places where the familiar gets disrupted. (Modern planet; no traditional dignity.)"
    },
    {
      "sourcePath": "packages/astro-knowledge/data/planetary/uranus.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "Uranus describes awakening, disruption, freedom, invention, rupture, surprise, and the part of life that refuses to stay trapped inside a stale pattern. It shows where someone needs room to change and where the old structure may no longer fit. Uranus takes about eighty-four years to move through all twelve signs and spends about seven years in each sign. Its house transits mark longer chapters of change, liberation, instability, and new possibility. Implies an innovative mind with unique communication styles. Those with this placement may invent or create revolutionary ideas in media, technology, or education."
    }
  ],
  "validation": {
    "complete": true,
...
BACKING FACTS
{
  ...
  "zodiacCircuit": "about 84 years",
  "typicalSignStay": "about 7 years per sign",
...
Words: learning, communication, change, life, old, need, stop, daily, patterns, conversations.
...
EXACT TASK
Write one complete continuous Current Sky fallback article for Uranus in Gemini. Create one recognizable lived sequence from the verified astrology. Return only opening, tension, development, close, and try_this.
