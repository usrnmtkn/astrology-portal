...
- Package: `tldr-astro-knowledge-matrix-v8-owner-approved-ingestion-ready.zip`, placed at `packages/astro-knowledge/voice/tldr-astro/owner-author-writer/knowledge-matrix-v8/` (transit meanings, house activations, import manifest, build report; copy preserved exactly per manifest `rewrite_or_clean_copy: false`).
