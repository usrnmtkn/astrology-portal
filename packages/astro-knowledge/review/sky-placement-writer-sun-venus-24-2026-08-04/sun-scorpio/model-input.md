...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "As a Scorpio Sun, you emanate depth, transformation, and intensity. You thrive on emotional intimacy and are unafraid to dive into life’s mysteries. Your determination is unyielding, and your passions run deep, allowing you to navigate life’s ups and downs with resilience.",
  "combinedMeaning": "With the Sun in Scorpio, the core self strengthens when you stop skimming the surface and face what is real. You are here to develop power through truth, trust, and emotional courage.",
  "collectiveGift": "The Sun in Scorpio: identity built through depth, honesty, and transformation.",
  "observableShadowBehaviors": [
    "Control",
    "secrecy",
    "suspicion",
    "holding pain until it becomes armor"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/sun-scorpio.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With the Sun in Scorpio, the core self strengthens when you stop skimming the surface and face what is real. You are here to develop power through truth, trust, and emotional courage."
    },
    {
...
{
  "priorSign": "libra",
  "priorSignEntryDate": "September 22, 2026",
  "priorSignExitDate": "October 23, 2026",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-sun-square-pluto-2026-10-26t12:11:47.999z",
    ...
    {
      "id": "aspect-sun-square-jupiter-2026-11-18t09:38:35.999z",
...
{
  "sign": "scorpio",
  "entryDate": "October 22, 2024",
  "exitDate": "November 21, 2024",
  "renderTokens": {
...
Words: life, emotional, truth, part, real, self, power, creative, trust, stop.
Owner phrase evidence: None selected for this placement.

EXACT TASK
Write one complete continuous Current Sky fallback article for Sun in Scorpio. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
