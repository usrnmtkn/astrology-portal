...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "With Venus in Virgo, your affection is shown through practical means. You value stability and show your love by taking care of the small details that contribute to your partner’s wellbeing. Your love language often involves acts of service, and you seek meaningful and productive relationships.",
  "combinedMeaning": "With Venus in Virgo, affection is shown in details, service, repair, and thoughtful support. Venus is in fall here, so receiving may need practice.",
  "collectiveGift": "Venus in Virgo: love is practical, attentive, and expressed through useful care.",
  "observableShadowBehaviors": [
    "Criticism",
    "overfunctioning",
    "making love something you have to earn by being flawless"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/venus-virgo.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Venus in Virgo, affection is shown in details, service, repair, and thoughtful support. Venus is in fall here, so receiving may need practice."
    },
    {
...
{
  "priorSign": "leo",
  "priorSignEntryDate": "June 13, 2026",
  "priorSignExitDate": "July 9, 2026",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-venus-square-uranus-2026-07-13t14:26:37.999z",
      "date": "July 13, 2026",
      "body": "venus-square-uranus",
      "eventType": "exact-aspect",
      "meaning": "Connection and value meet disruption and freedom. Attraction runs electric, sudden, and unattached to convention. Psychologically the square is inner tension to integrate: Erratic affections, sudden attractions and ruptures, and a refusal to be tied down. The growth is owning both sides instead of splitting them.",
      "meaningSource": "packages/astro-knowledge/data/transits/venus-square-uranus.json"
    },
    {
      "id": "aspect-venus-square-mars-2026-07-29t07:09:49.999z",
      "date": "July 29, 2026",
      "body": "venus-square-mars",
      "eventType": "exact-aspect",
      "meaning": "Attraction meets drive. Desire, and the channeling of energy into pleasure, art, or pursuit. The conjunction can either fuse charm and drive or have the two cancel out. Psychologically the square is inner tension to integrate: Bad timing in romance, indecision, and friction between wanting and acting. The growth is owning both sides instead of splitting them.",
      "meaningSource": "packages/astro-knowledge/data/transits/venus-square-mars.json"
    }
  ]
}
...
{
  "sign": "virgo",
  "entryDate": "August 4, 2024",
  "exitDate": "August 29, 2024",
  "renderTokens": {
...
Words: love, real, care, need, small, life, work, worth, keep, show.
Owner phrase evidence: “unconscious patterns”; “stop apologizing”; “trying to earn”. Use sparingly and do not build the paragraph around a phrase.

EXACT TASK
Write one complete continuous Current Sky fallback article for Venus in Virgo. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.

OWNER PASSAGE 1
This isn't about optimization or life-hacking or any of capitalism's favorite words for extracting more productivity from our already exhausted bodies. This is the act of caring for ourselves and each other in a world designed to deplete us.
