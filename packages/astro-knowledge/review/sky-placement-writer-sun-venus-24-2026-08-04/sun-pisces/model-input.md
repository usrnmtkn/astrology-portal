...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "As a Pisces Sun, you emanate empathy, spiritual depth, and a strong intuitive sense. You are in tune with the collective unconscious and often show a selfless desire to help others. Your imaginative and compassionate nature allows you to navigate the world with grace and sensitivity.",
  "combinedMeaning": "With the Sun in Pisces, the core self strengthens through empathy, creativity, intuition, and connection to what cannot be measured. You are here to keep your heart open while still staying embodied.",
  "collectiveGift": "The Sun in Pisces: identity built through compassion, imagination, and spiritual sensitivity.",
  "observableShadowBehaviors": [
    "Escapism",
    "blurred boundaries",
    "disappearing into others' needs"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/sun-pisces.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With the Sun in Pisces, the core self strengthens through empathy, creativity, intuition, and connection to what cannot be measured. You are here to keep your heart open while still staying embodied."
    },
    {
...
{
  "priorSign": "aquarius",
  "priorSignEntryDate": "January 20, 2027",
  "priorSignExitDate": "February 18, 2027",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-sun-square-uranus-2027-02-20t15:10:41.999z",
...
{
  "sign": "pisces",
  "entryDate": "February 18, 2025",
  "exitDate": "March 20, 2025",
  "renderTokens": {
...
Words: rather, world, self, life, worth, time, past, need, let, love.
...
EXACT TASK
Write one complete continuous Current Sky fallback article for Sun in Pisces. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
