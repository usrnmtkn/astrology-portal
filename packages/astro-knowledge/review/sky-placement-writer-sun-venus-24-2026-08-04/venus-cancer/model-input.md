...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "With Venus in Cancer, your love is nurturing, protective, and deep. Home and family are central to your sense of comfort and security in a relationship.",
  "combinedMeaning": "With Venus in Cancer, affection shows through care, memory, home, food, and the desire to make someone feel safe. You value devotion that feels emotionally real.",
  "collectiveGift": "Venus in Cancer: love is protective, tender, and rooted in emotional belonging.",
  "observableShadowBehaviors": [
    "Clinging",
    "defensiveness",
    "using care to secure attachment"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/venus-cancer.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Venus in Cancer, affection shows through care, memory, home, food, and the desire to make someone feel safe. You value devotion that feels emotionally real."
    },
    {
...
{
  "priorSign": "gemini",
  "priorSignEntryDate": "June 8, 2027",
  "priorSignExitDate": "July 2, 2027",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-venus-square-neptune-2027-07-08t12:27:55.999z",
      "date": "July 8, 2027",
    ...
    {
      "id": "aspect-venus-square-saturn-2027-07-25t15:19:27.999z",
      "date": "July 25, 2027",
...
Words: real, feel, love, care, home, emotional, worth, relationship, rather, connection.
Owner phrase evidence: None selected for this placement.

EXACT TASK
Write one complete continuous Current Sky fallback article for Venus in Cancer. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
