...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "With Venus in Gemini, your love life is marked by curiosity and excitement. Intellectual conversations captivate you, and a mental connection is often a prerequisite for romance. You value variety and intellectual compatibility in relationships.",
  "combinedMeaning": "With Venus in Gemini, attraction grows through words, wit, variety, and the pleasure of being mentally met. You value connection that keeps moving and learning.",
  "collectiveGift": "Venus in Gemini: love needs conversation, curiosity, and mental play.",
  "observableShadowBehaviors": [
    "Restlessness",
    "mixed signals",
    "treating intimacy like an idea to sample"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/venus-gemini.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Venus in Gemini, attraction grows through words, wit, variety, and the pleasure of being mentally met. You value connection that keeps moving and learning."
    },
    {
...
{
  "priorSign": "taurus",
  "priorSignEntryDate": "May 14, 2027",
  "priorSignExitDate": "June 8, 2027",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-venus-trine-pluto-2027-06-14t04:03:15.999z",
      "date": "June 14, 2027",
      "body": "venus-trine-pluto",
      "eventType": "exact-aspect",
      "meaning": "Love and value meet intensity. All-or-nothing attraction, deep desire, and a strong pull toward control in relationships. The trine makes this a natural strength: Depth and devotion in love, used deliberately. The growth edge is not to coast on the ease.",
      "meaningSource": "packages/astro-knowledge/data/transits/venus-trine-pluto.json"
    },
    {
      "id": "aspect-venus-sextile-neptune-2027-06-13t19:57:07.999z",
      "date": "June 13, 2027",
...
{
  "sign": "gemini",
  "entryDate": "April 24, 2026",
  "exitDate": "May 18, 2026",
  "renderTokens": {
...
Words: connection, real, learning, life, needs, love, rather, feel, conversations, worth.
Owner phrase evidence: “stop pretending”; “routines and health”; “professional life”. Use sparingly and do not build the paragraph around a phrase.

EXACT TASK
Write one complete continuous Current Sky fallback article for Venus in Gemini. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
...
OWNER PASSAGE 6
Will this investment support long-term well-being? The impulse buying of other Venus signs gives way to thoughtful curation of resources.
