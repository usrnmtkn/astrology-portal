...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "As a Virgo Sun, you personify efficiency, practicality, and a focus on service. You’re detail-oriented and often drawn to tasks that involve analysis or helping others. You shine when precision and care are needed, and your work ethic is second to none.",
  "combinedMeaning": "With the Sun in Virgo, the core self strengthens through improving what is real, tending the details, and making life work better. You are here to refine without reducing yourself to what still needs fixing.",
  "collectiveGift": "The Sun in Virgo: identity built through skill, discernment, and useful service.",
  "observableShadowBehaviors": [
    "Perfectionism",
    "criticism",
    "turning self-improvement into self-harm"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/sun-virgo.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With the Sun in Virgo, the core self strengthens through improving what is real, tending the details, and making life work better. You are here to refine without reducing yourself to what still needs fixing."
    },
    {
...
{
  "priorSign": "leo",
  "priorSignEntryDate": "July 22, 2026",
  "priorSignExitDate": "August 22, 2026",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-sun-square-uranus-2026-08-28t22:18:54.999z",
      "date": "August 28, 2026",
      "body": "sun-square-uranus",
      "eventType": "exact-aspect",
      "meaning": "Identity meets independence and disruption. The urge to be different and to do things your own way. Psychologically the square is inner tension to integrate: Difference for its own sake: eccentricity, instability, shocking others to no purpose. The growth is owning both sides instead of splitting them.",
      "meaningSource": "packages/astro-knowledge/data/transits/sun-square-uranus.json"
    },
    {
      "id": "aspect-sun-sextile-mars-2026-09-14t19:52:48.999z",
      "date": "September 14, 2026",
      "body": "sun-sextile-mars",
      "eventType": "exact-aspect",
      "meaning": "Identity meets drive and aggression. Energy, assertion, and the will to act become central to the sense of self. The sextile makes this a natural strength: Action with little temper behind it. Things get done and the drive feels available rather than volatile. The growth edge is not to coast on the ease.",
      "meaningSource": "packages/astro-knowledge/data/transits/sun-sextile-mars.json"
    }
  ]
}
...
Words: self, life, work, needs, real, stop, keep, trying, care, see.
...
EXACT TASK
Write one complete continuous Current Sky fallback article for Sun in Virgo. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
