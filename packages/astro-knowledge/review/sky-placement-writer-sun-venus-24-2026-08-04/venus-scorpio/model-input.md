...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "With Venus in Scorpio, your love is intense, passionate, and transformative. You seek deep emotional bonds and are drawn to mysteries and the hidden depths of your partner. Your relationships are intimate, reflecting your desire for deep emotional exchange.",
  "combinedMeaning": "With Venus in Scorpio, attraction wants depth, loyalty, truth, and emotional risk. Venus is in detriment here, so attachment can become all-or-nothing until trust is handled consciously.",
  "collectiveGift": "Venus in Scorpio: love is intense, private, and transformative.",
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/venus-scorpio.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Venus in Scorpio, attraction wants depth, loyalty, truth, and emotional risk. Venus is in detriment here, so attachment can become all-or-nothing until trust is handled consciously."
    },
    {
...
{
  "priorSign": "libra",
  "priorSignEntryDate": "August 6, 2026",
  "priorSignExitDate": "September 10, 2026",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-venus-square-pluto-2026-09-15t18:34:51.999z",
      "date": "September 15, 2026",
      "body": "venus-square-pluto",
      "eventType": "exact-aspect",
      "meaning": "Love and value meet intensity. All-or-nothing attraction, deep desire, and a strong pull toward control in relationships. Psychologically the square is inner tension to integrate: Power struggles, jealousy, and treating happiness as a kind of vulnerability to be guarded against. The growth is owning both sides instead of splitting them.",
      "meaningSource": "packages/astro-knowledge/data/transits/venus-square-pluto.json"
    },
    {
      "id": "aspect-venus-square-mars-2026-10-10t21:31:07.999z",
...
{
  "sign": "scorpio",
  "entryDate": "September 22, 2024",
  "exitDate": "October 17, 2024",
  "renderTokens": {
...
Words: emotional, love, deep, real, worth, truth, feel, relationships, instead, rather.
Owner phrase evidence: None selected for this placement.

EXACT TASK
Write one complete continuous Current Sky fallback article for Venus in Scorpio. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
