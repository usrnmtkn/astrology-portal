...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "With Venus in Sagittarius, your love is adventurous, optimistic, and freedom-loving. You prioritize honesty, intellectual stimulation, and shared adventures in relationships. You’re drawn to open-minded individuals who can broaden your horizons and share your zest for life.",
  "combinedMeaning": "With Venus in Sagittarius, attraction grows through adventure, laughter, truth, and a wider horizon. You value relationships that expand rather than confine.",
  "collectiveGift": "Venus in Sagittarius: love needs freedom, honesty, and shared exploration.",
  "observableShadowBehaviors": [
    "Restlessness",
    "bluntness",
    "leaving when accountability feels like limitation"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/venus-sagittarius.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Venus in Sagittarius, attraction grows through adventure, laughter, truth, and a wider horizon. You value relationships that expand rather than confine."
    },
    {
...
{
  "priorSign": "scorpio",
  "priorSignEntryDate": "December 4, 2026",
  "priorSignExitDate": "January 7, 2027",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-venus-sextile-pluto-2027-01-11t19:26:13.999z",
      "date": "January 11, 2027",
      "body": "venus-sextile-pluto",
      "eventType": "exact-aspect",
      "meaning": "Love and value meet intensity. All-or-nothing attraction, deep desire, and a strong pull toward control in relationships. The sextile makes this a natural strength: Depth and devotion in love, used deliberately. The growth edge is not to coast on the ease.",
      "meaningSource": "packages/astro-knowledge/data/transits/venus-sextile-pluto.json"
    },
    {
      "id": "aspect-venus-trine-neptune-2027-01-09t02:44:40.999z",
      "date": "January 8, 2027",
...
{
  "sign": "sagittarius",
  "entryDate": "November 30, 2025",
  "exitDate": "December 24, 2025",
  "renderTokens": {
...
Words: relationships, love, rather, life, truth, feel, real, needs, worth, money.
Owner phrase evidence: None selected for this placement.

EXACT TASK
Write one complete continuous Current Sky fallback article for Venus in Sagittarius. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
