...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "With Venus in Libra, you value balance, harmony, and partnership in love. You are diplomatic and fair-minded in your relationships and are drawn to beauty and charm. Your sense of romance involves a deep appreciation for cooperation and shared experiences.",
  "combinedMeaning": "With Venus in Libra, Venus is at home, so relationship intelligence, social grace, and aesthetic balance are strong. You value partnership that feels reciprocal and elegant.",
  "collectiveGift": "Venus in Libra: love seeks harmony, beauty, fairness, and mutuality.",
  "observableShadowBehaviors": [
    "Approval-seeking",
    "indecision",
    "keeping the peace while betraying your own values"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/venus-libra.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Venus in Libra, Venus is at home, so relationship intelligence, social grace, and aesthetic balance are strong. You value partnership that feels reciprocal and elegant."
    },
    {
...
{
  "priorSign": "virgo",
  "priorSignEntryDate": "July 9, 2026",
  "priorSignExitDate": "August 6, 2026",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-venus-trine-pluto-2026-08-10t18:08:38.999z",
      "date": "August 10, 2026",
    ...
    {
      "id": "aspect-venus-trine-uranus-2026-08-12t03:46:10.999z",
      "date": "August 11, 2026",
...
{
  "sign": "libra",
  "entryDate": "August 29, 2024",
  "exitDate": "September 22, 2024",
  "renderTokens": {
...
Words: love, balance, real, relationships, rather, worth, connection, feels, emotional, work.
Owner phrase evidence: “keeping the peace”; “professional life”; “personal values”. Use sparingly and do not build the paragraph around a phrase.

EXACT TASK
Write one complete continuous Current Sky fallback article for Venus in Libra. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
