...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "As a Capricorn Sun, you exude discipline, ambition, and a strong sense of responsibility. You have a natural knack for management and strategy, and you shine when setting long-term goals. Your practical and cautious approach to life is often a model of success for others.",
  "combinedMeaning": "With the Sun in Capricorn, the core self strengthens through discipline, structure, ambition, and earned authority. You are here to build something durable without sacrificing your humanity to the climb.",
  "collectiveGift": "The Sun in Capricorn: identity built through responsibility, mastery, and long-term creation.",
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/sun-capricorn.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With the Sun in Capricorn, the core self strengthens through discipline, structure, ambition, and earned authority. You are here to build something durable without sacrificing your humanity to the climb."
    },
    {
...
BACKING FACTS
{
  ...
  "priorSignEntryDate": "November 22, 2026",
  "priorSignExitDate": "December 21, 2026",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-sun-square-neptune-2026-12-23t11:37:14.999z",
    ...
    {
      "id": "aspect-sun-square-saturn-2026-12-29t23:27:46.999z",
...
{
  "sign": "capricorn",
  "entryDate": "December 21, 2024",
  "exitDate": "January 19, 2025",
  "renderTokens": {
...
Words: life, long, worth, part, self, creative, rather, money, emotional, time.
Owner phrase evidence: None selected for this placement.

EXACT TASK
Write one complete continuous Current Sky fallback article for Sun in Capricorn. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
