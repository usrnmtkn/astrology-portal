...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "With your Sun in Leo, you radiate warmth, generosity, and a zest for life. Your presence is often magnetic, drawing others to you naturally. You shine when expressing your creativity and have a strong drive for personal recognition and a desire to be at the center of attention.",
  "combinedMeaning": "With the Sun in Leo, the core self strengthens through being seen, creating boldly, and leading from the heart. The Sun is at home in Leo, so confidence works cleanly when it has a generous purpose.",
  "collectiveGift": "The Sun in Leo: identity built through expression, visibility, and creative warmth.",
  "observableShadowBehaviors": [
    "Pride",
    "vanity",
    "drama",
    "or measuring your value by applause instead of integrity"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/sun-leo.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With the Sun in Leo, the core self strengthens through being seen, creating boldly, and leading from the heart. The Sun is at home in Leo, so confidence works cleanly when it has a generous purpose."
    },
    {
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-sun-trine-neptune-2026-07-27t07:36:37.999z",
      "date": "July 27, 2026",
    ...
    {
      "id": "aspect-sun-sextile-uranus-2026-07-27t21:36:24.999z",
      "date": "July 27, 2026",
...
{
  "sign": "leo",
  "entryDate": "July 22, 2024",
  "exitDate": "August 22, 2024",
  "renderTokens": {
...
Words: life, creative, self, attention, part, home, personal, heart, emotional, time.
Owner phrase evidence: “time to reflect”; “trying to earn”; “need to prove”. Use sparingly and do not build the paragraph around a phrase.

EXACT TASK
Write one complete continuous Current Sky fallback article for Sun in Leo. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
