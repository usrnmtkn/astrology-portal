...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "As a Cancer Sun, you exude nurturing energy and emotional sensitivity. You highly value family and home and take pride in caring for loved ones. You’re guided by your emotions and intuition, and you have an innate ability to provide comfort and security to those around you.",
  "combinedMeaning": "With the Sun in Cancer, the core self strengthens when you protect what matters and build spaces where tenderness can survive. You are here to trust emotional intelligence as real guidance.",
  "collectiveGift": "The Sun in Cancer: identity built through care, memory, and emotional belonging.",
  "observableShadowBehaviors": [
    "Defensiveness",
    "clinging",
    "caring for others while hiding your own needs"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/sun-cancer.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With the Sun in Cancer, the core self strengthens when you protect what matters and build spaces where tenderness can survive. You are here to trust emotional intelligence as real guidance."
    },
    {
...
{
  "priorSign": "gemini",
  "priorSignEntryDate": "May 21, 2027",
  "priorSignExitDate": "June 21, 2027",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-sun-square-neptune-2027-06-28t12:50:48.999z",
      "date": "June 28, 2027",
      "body": "sun-square-neptune",
      "eventType": "exact-aspect",
      "meaning": "Identity meets imagination and idealism. Heightened sensitivity, imagination, and a pull toward the ideal. Psychologically the square is inner tension to integrate: Susceptibility to illusion and escapism, and to the rescuer/rescued dynamic. The self can get foggy. The growth is owning both sides instead of splitting them.",
      "meaningSource": "packages/astro-knowledge/data/transits/sun-square-neptune.json"
    },
    {
      "id": "aspect-sun-square-saturn-2027-07-20t10:48:54.999z",
      "date": "July 20, 2027",
      "body": "sun-square-saturn",
      "eventType": "exact-aspect",
      "meaning": "Identity meets limit and discipline. The self is built slowly, under weight, and tested against duty and consequence. Psychologically the square is inner tension to integrate: A heavy self-concept: difficulty with authority figures, self-doubt, and a chronic sense of falling short. The remedy is steady, useful work. The growth is owning both sides instead of splitting them.",
      "meaningSource": "packages/astro-knowledge/data/transits/sun-square-saturn.json"
    }
  ]
}
...
{
  "sign": "cancer",
  "entryDate": "June 20, 2025",
  "exitDate": "July 22, 2025",
  "renderTokens": {
...
Words: emotional, life, real, self, home, needs, family, trust, care, rather.
Owner phrase evidence: None selected for this placement.

EXACT TASK
Write one complete continuous Current Sky fallback article for Sun in Cancer. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.

OWNER PASSAGE 1
Venus in Taurus makes a close Trine to the South Node in Virgo and a Sextile to the North Node in Pisces. This is the essence of the Cancer New Moon message: true security comes not from building higher walls or better defenses, but from recognizing that our safety is intertwined with everyone else's.
