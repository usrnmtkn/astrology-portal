...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "With Venus in Capricorn, your love is mature, loyal, and reserved. You value practicality and reliability, preferring to show your affection through steadfast support and shared ambitions.",
  "combinedMeaning": "With Venus in Capricorn, affection may be reserved at first, but it values commitment, reliability, and shared ambition. Love becomes real through consistency.",
  "collectiveGift": "Venus in Capricorn: love is serious, loyal, and built through time.",
  "observableShadowBehaviors": [
    "Guardedness",
    "transactional relating",
    "confusing emotional safety with control"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/venus-capricorn.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Venus in Capricorn, affection may be reserved at first, but it values commitment, reliability, and shared ambition. Love becomes real through consistency."
    },
    {
...
BACKING FACTS
{
  ...
  "priorSignEntryDate": "January 7, 2027",
  "priorSignExitDate": "February 3, 2027",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-venus-square-neptune-2027-02-05t17:34:13.999z",
      "date": "February 5, 2027",
      "body": "venus-square-neptune",
      "eventType": "exact-aspect",
      "meaning": "Love and value meet imagination. Heightened artistic sensibility and romantic idealism. Psychologically the square is inner tension to integrate: Seeing what you want to see in love, idealizing others, and the disillusionment that follows. The growth is owning both sides instead of splitting them.",
      "meaningSource": "packages/astro-knowledge/data/transits/venus-square-neptune.json"
    },
    {
      "id": "aspect-venus-square-saturn-2027-02-13t11:40:12.999z",
      "date": "February 13, 2027",
      "body": "venus-square-saturn",
      "eventType": "exact-aspect",
      "meaning": "Affection and value meet limit. Loyalty, restraint in pleasure and love, and a strong sense of obligation. Psychologically the square is inner tension to integrate: Difficulty enjoying success, fear of loss, blocked rewards, and free-floating guilt. The growth is owning both sides instead of splitting them.",
      "meaningSource": "packages/astro-knowledge/data/transits/venus-square-saturn.json"
    }
  ]
}
...
{
  "sign": "capricorn",
  "entryDate": "December 24, 2025",
  "exitDate": "January 17, 2026",
  "renderTokens": {
...
Words: love, real, emotional, worth, time, feel, rather, money, connection, show.
Owner phrase evidence: None selected for this placement.

EXACT TASK
Write one complete continuous Current Sky fallback article for Venus in Capricorn. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
