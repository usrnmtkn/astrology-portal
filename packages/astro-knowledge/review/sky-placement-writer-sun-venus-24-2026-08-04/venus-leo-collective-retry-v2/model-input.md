...
Collective voice is mandatory in every field: do not use you, your, yours, yourself, or yourselves, including inside quoted or imagined speech.
...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "With Venus in Leo, your love is dramatic, warm, and generous. You appreciate grand gestures of love and seek to be adored and admired in your relationships. You are drawn to those who are confident and expressive, and you enjoy sharing a glamorous social life with your partner.",
  "combinedMeaning": "With Venus in Leo, affection wants joy, celebration, romance, and visible appreciation. You value love that feels alive, proud, and creative.",
  "collectiveGift": "Venus in Leo: love is warm, expressive, and generous with the heart.",
  "observableShadowBehaviors": [
    "Drama",
    "vanity",
    "needing admiration to believe love is present"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/venus-leo.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Venus in Leo, affection wants joy, celebration, romance, and visible appreciation. You value love that feels alive, proud, and creative."
    },
    {
...
{
  "priorSign": "cancer",
  "priorSignEntryDate": "July 2, 2027",
  "priorSignExitDate": "July 27, 2027",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-venus-trine-neptune-2027-08-01t19:32:48.999z",
      "date": "August 1, 2027",
      "body": "venus-trine-neptune",
      "eventType": "exact-aspect",
      "meaning": "Love and value meet imagination. Heightened artistic sensibility and romantic idealism. The trine makes this a natural strength: Refined aesthetic and tender, imaginative affection. The growth edge is not to coast on the ease.",
      "meaningSource": "packages/astro-knowledge/data/transits/venus-trine-neptune.json"
    },
    {
      "id": "aspect-venus-sextile-uranus-2027-08-03t23:53:22.999z",
      "date": "August 3, 2027",
      "body": "venus-sextile-uranus",
      "eventType": "exact-aspect",
      "meaning": "Connection and value meet disruption and freedom. Attraction runs electric, sudden, and unattached to convention. The sextile makes this a natural strength: Exciting, unconventional bonds and an original aesthetic; freedom inside closeness. The growth edge is not to coast on the ease.",
      "meaningSource": "packages/astro-knowledge/data/transits/venus-sextile-uranus.json"
    }
  ]
}
...
Words: love, real, worth, feel, life, relationships, creative, connection, emotional, time.
Owner phrase evidence: “time to reflect”; “trying to earn”; “left behind”. Use sparingly and do not build the paragraph around a phrase.

EXACT TASK
Write one complete continuous Current Sky fallback article for Venus in Leo. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
