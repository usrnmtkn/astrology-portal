...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "With your Sun in Aquarius, you embody individuality, innovation, and a deep sense of humanitarianism. You thrive on uniqueness and often seek to challenge the status quo. You shine in situations where you can utilize your inventive mind and make a difference in the world.",
  "combinedMeaning": "With the Sun in Aquarius, the core self strengthens through independent thought, social awareness, and the courage to live outside stale expectations. The Sun is in detriment in Aquarius, so identity forms against the group as much as within it. You are here to bring perspective that serves more than the self.",
  "collectiveGift": "The Sun in Aquarius: identity built through originality, community, and future vision.",
  "observableShadowBehaviors": [
    "Detachment",
    "contrarianism",
    "confusing distance with freedom"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/sun-aquarius.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With the Sun in Aquarius, the core self strengthens through independent thought, social awareness, and the courage to live outside stale expectations. The Sun is in detriment in Aquarius, so identity forms against the group as much as within it. You are here to bring perspective that serves more than the self."
    },
    {
...
{
  "priorSign": "capricorn",
  "priorSignEntryDate": "December 21, 2026",
  "priorSignExitDate": "January 20, 2027",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-sun-sextile-neptune-2027-01-22t08:29:40.999z",
    ...
    {
      "id": "aspect-sun-trine-uranus-2027-01-22t02:18:56.999z",
      "date": "January 21, 2027",
      "body": "sun-trine-uranus",
      "eventType": "exact-aspect",
      "meaning": "Identity meets independence and disruption. The urge to be different and to do things your own way. The trine makes this a natural strength: Originality that reads as brilliance or healthy independence. The growth edge is not to coast on the ease.",
      "meaningSource": "packages/astro-knowledge/data/transits/sun-trine-uranus.json"
    }
  ]
}
...
{
  "sign": "aquarius",
  "entryDate": "January 19, 2025",
  "exitDate": "February 18, 2025",
  "renderTokens": {
...
Words: self, life, world, let, look, asks, deep, time, vision, power.
...
EXACT TASK
Write one complete continuous Current Sky fallback article for Sun in Aquarius. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.
