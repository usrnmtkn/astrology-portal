...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "With your Sun in Sagittarius, you reflect a love of freedom, adventure, and truth-seeking. You’re drawn to exploring life’s big questions and aren’t afraid to travel far and wide in your search for answers. Your optimistic nature and broad-minded outlook make you a natural philosopher.",
  "combinedMeaning": "With the Sun in Sagittarius, the core self strengthens through exploration, study, candor, and the search for meaning. You are here to keep widening the view while embodying what you claim to believe.",
  "collectiveGift": "The Sun in Sagittarius: identity built through truth, freedom, and lived wisdom.",
  "observableShadowBehaviors": [
    "Restlessness",
    "exaggeration",
    "using philosophy to avoid accountability"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/sun-sagittarius.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With the Sun in Sagittarius, the core self strengthens through exploration, study, candor, and the search for meaning. You are here to keep widening the view while embodying what you claim to believe."
    },
    {
...
{
  "priorSign": "scorpio",
  "priorSignEntryDate": "October 23, 2026",
  "priorSignExitDate": "November 22, 2026",
  "renderTokens": {
    "priorSign": "{{priorSign}}",
...
BACKING FACTS
{
  "eventsDuringTransit": [
    {
      "id": "aspect-sun-sextile-pluto-2026-11-25t17:27:21.999z",
      "date": "November 25, 2026",
      "body": "sun-sextile-pluto",
      "eventType": "exact-aspect",
      "meaning": "Identity meets power and intensity. A magnetic, high-voltage presence that others react to immediately. The sextile makes this a natural strength: Strength and depth, well-controlled. A natural aptitude for investigation, healing, and transformation. The growth edge is not to coast on the ease.",
      "meaningSource": "packages/astro-knowledge/data/transits/sun-sextile-pluto.json"
    },
    {
      "id": "aspect-sun-trine-neptune-2026-11-24t00:07:40.999z",
      "date": "November 23, 2026",
      "body": "sun-trine-neptune",
      "eventType": "exact-aspect",
      "meaning": "Identity meets imagination and idealism. Heightened sensitivity, imagination, and a pull toward the ideal. The trine makes this a natural strength: Imaginative and compassionate; creative and charitable directions come naturally. The growth edge is not to coast on the ease.",
      "meaningSource": "packages/astro-knowledge/data/transits/sun-trine-neptune.json"
    }
  ]
}
...
{
  "sign": "sagittarius",
  "entryDate": "November 21, 2024",
  "exitDate": "December 21, 2024",
  "renderTokens": {
...
Words: life, truth, self, keep, creative, part, love, rather, wide, fire.
Owner phrase evidence: None selected for this placement.

EXACT TASK
Write one complete continuous Current Sky fallback article for Sun in Sagittarius. Keep the transit as the subject and use lived moments as evidence without letting one invented scenario carry the card. Return only opening, tension, development, close, and try_this.

OWNER PASSAGE 1
The courage to choose differently lives here. What’s been stuck starts to move. What’s been suppressed finds its voice. The challenge is real, but so is the momentum.
