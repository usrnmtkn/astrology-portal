...
VERIFIED ASTROLOGY
{
  ...
  "signExpression": "With Mercury in Gemini, you’re quick-witted and express thoughts eloquently. Skilled in conversation, you’re always ready to exchange ideas. Your adaptable and curious mind enjoys exploring multiple subjects.",
  "combinedMeaning": "With Mercury in Gemini, Mercury is at home, so language, learning, questions, and exchange move naturally. You think by exploring options and linking one idea to the next.",
  "collectiveGift": "Mercury in Gemini: the mind is quick, curious, and fluent in connection.",
  "observableShadowBehaviors": [
    "Scattered attention",
    "overtalking",
    "mistaking cleverness for depth"
  ],
  ...
  "sourcePassages": [
    {
      "sourcePath": "packages/astro-knowledge/data/placements/sign/mercury-gemini.json",
      "status": "REVIEWED",
      "register": "source_meaning_only_may_be_natal",
      "personBoundary": "Do not reproduce second-person or natal address from this source.",
      "text": "With Mercury in Gemini, Mercury is at home, so language, learning, questions, and exchange move naturally. You think by exploring options and linking one idea to the next."
    },
    {
...
Words: learning, need, stop, patterns, communication, home, let, attention, work, connection.
...
EXACT TASK
Write one complete continuous Current Sky fallback article for Mercury in Gemini. Create one recognizable lived sequence from the verified astrology. Return only opening, tension, development, close, and try_this.
...
OWNER PASSAGE 6
This Mercury is no trickster. It’s the archivist. The land surveyor. The one who returns to the burial site and asks: what was buried to be hidden?
