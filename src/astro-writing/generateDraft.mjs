...
export function buildDraftInput({
  ...
  const sections = [
    ...
    "ARGUMENT DEVELOPMENT IS A REASONING AUDIT, NOT A PROSE TEMPLATE. When this is a developed natal placement, Chiron interpretation, or other long-form recurring-pattern passage, distinguish the mechanism from its topic list; show any supported adaptation as intelligent before naming its cost; identify the contradiction that keeps it operating; integrate the house into how the mechanism works; and let development change behavior or operating assumptions. Do not invent biography, force this arc onto a short or forecast surface, or reuse wording from a structural calibration example.",
